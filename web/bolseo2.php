...
if(isset($_POST['submit']))
{
	...
	for($i=0; $i<$nMaquinas; $i++)
	{
		...
		$qResumen		=	"INSERT INTO resumen_maquina_bs (id_bolseo,kilogramos,millares,dtira,dtroquel,segundas,id_maquina,id_operador) VALUES ".
		...
		$qDetalles		=	"INSERT INTO detalle_resumen_maquina_bs (id_resumen_maquina_bs,kilogramos,millares,dtira,dtroquel,segundas,orden,kam,factor) VALUES";
		$eDetalles		=	"";
...
<div  id="container" style="margin:0px auto">
	...
	<div align="center" style="width:100%">
		...
		<h3 align="left" >BOLSEADORA<?=$dat_lic['numero']?>:		
		...
		<? 
		$qOperador = "SELECT * FROM operadores WHERE status = '0' AND area = '2'  AND activo = 0 ORDER BY nombre ASC";
		$rOperador = mysql_query($qOperador);
		...
		<div align="center" id="tabla_<?=$dat_lic['id_maquina']?>">
			<table width="630" align="center" border="0" class="tablaCentrada">
				<tr>	
				...
				<?php for($a=1;$a<=$nEntradas;$a++) { ?>
					<tr >
					  ...
					  <td align="center"><input type="text" size="4" id="factor_<?=$dat_lic['id_maquina']?>_<?=$a?>" name="factor_<?=$dat_lic['id_maquina']?>[]"  onChange="convertir(<?=$dat_lic['id_maquina']?>,<?=$a?>);" /></td>
   					  <td ><input type="text" class="numeros" id="ml_<?=$dat_lic['id_maquina']?>_<?=$a?>" 	name="ml_<?=$dat_lic['id_maquina']?>[]" 	onFocus="this.select()" 	onBlur="addTextBolseo2(<?=$dat_lic['id_maquina']?>,<?=$a?>,<?=$_REQUEST['turno']?>); convertir(<?=$dat_lic['id_maquina']?>,<?=$a?>); sumaLocal(<?=$dat_lic['id_maquina']?>);" onChange="mh(<?=$_REQUEST['turno']?>);" /></td>
					  <td ><input type="text" class="numeros" id="kg_<?=$dat_lic['id_maquina']?>_<?=$a?>" 	name="kg_<?=$dat_lic['id_maquina']?>[]" 	onFocus="this.select()"		onBlur="addTextBolseo2(<?=$dat_lic['id_maquina']?>,<?=$a?>,<?=$_REQUEST['turno']?>); convertir(<?=$dat_lic['id_maquina']?>,<?=$a?>); sumaLocal(<?=$dat_lic['id_maquina']?>);" onChange="mh(<?=$_REQUEST['turno']?>);" /></td>
					  <td ><input type="text" class="numeros" id="dt_<?=$dat_lic['id_maquina']?>_<?=$a?>" 	name="dt_<?=$dat_lic['id_maquina']?>[]" 	onFocus="this.select()" 	onBlur="sumaLocal(<?=$dat_lic['id_maquina']?>);" /></td>
					  <td ><input type="text" class="numeros" id="dtr_<?=$dat_lic['id_maquina']?>_<?=$a?>" 	name="dtr_<?=$dat_lic['id_maquina']?>[]" 	onFocus="this.select()" 	onBlur="sumaLocal(<?=$dat_lic['id_maquina']?>);" /></td>
					  <td ><input type="text" class="numeros" id="se_<?=$dat_lic['id_maquina']?>_<?=$a?>" 	name="se_<?=$dat_lic['id_maquina']?>[]" 	onFocus="this.select()"   	onBlur="sumaLocal(<?=$dat_lic['id_maquina']?>);" /></td>
				  </tr>
                  <tr>
				...
				<?php } ?>
					<tr>
						...
						<td><input type="text" id="mls_<?=$dat_lic['id_maquina']?>" 	name="mls_<?=$dat_lic['id_maquina']?>" 	value="0" class="subtotal" onFocus="this.select()" size="6"  /></td>
						<td><input type="text" id="kgs_<?=$dat_lic['id_maquina']?>" 	name="kgs_<?=$dat_lic['id_maquina']?>" 	value="0" class="subtotal" onFocus="this.select()" /></td>
						<td><input type="text" id="dts_<?=$dat_lic['id_maquina']?>" 	name="dts_<?=$dat_lic['id_maquina']?>" 	value="0" class="subtotal" onFocus="this.select()" /></td>
						<td><input type="text" id="dtrs_<?=$dat_lic['id_maquina']?>" 	name="dtrs_<?=$dat_lic['id_maquina']?>" value="0" class="subtotal" onFocus="this.select()" /></td>
						<td><input type="text" id="ses_<?=$dat_lic['id_maquina']?>" 	name="ses_<?=$dat_lic['id_maquina']?>" 	value="0" class="subtotal" onFocus="this.select()" /></td>
                    </tr>
			</table>
			</div>
        </div>
        ...
        <table align="center">
					<tr>
						...
						<td><input type="text" id="tml"  name="tml"  value="" class="total" readonly="readonly" /></td>
						<td><input type="text" id="tkg"  name="tkg"  value="" class="total" readonly="readonly" /></td>
						<td><input type="text" id="tdt"  name="tdt"  value="" class="total" readonly="readonly" /></td>
						<td><input type="text" id="tdtr" name="tdtr" value="" class="total" readonly="readonly" /></td>
						<td><input type="text" id="tse"  name="tse"  value="" class="total" readonly="readonly" /></td>
					</tr>
                    <tr>
                    	<td><strong>Millares por Hora:</strong></td>
                        <td colspan="5"><input type="text" id="m_p" name="m_p" value="" readonly="readonly" class="total" /></td>
                    </tr>
                    <tr>
...
if( $nMetas < 1) { ?>
	...
	$qnumM	=	"SELECT * FROM maquina WHERE area = '1'";
...
<?
	...
	$qFecha	=	"SELECT fecha FROM bolseo WHERE id_bolseo = ".$ID_ORDENPRODUCCION."";
