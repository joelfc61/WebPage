...
<tr>
	...
	<option value="5" <? if($modificar && $dDatos['area'] == 5){ echo "selected"; } ?>>RPS</option>	
	<option value="6" <? if($modificar && $dDatos['area'] == 6){ echo "selected"; } ?>>SF</option>		
...
<tr>
	...
	<? if($dDatos['area'] == 5){ echo "RPS"; } ?>
	<? if($dDatos['area'] == 6){ echo "SF"; } ?>
        ...
        <td colspan="2" align="left" valign="middle">
        	<form action="admin.php?seccion=<?=$_REQUEST['seccion']?>" method="post" name="busca" id="busca">
              <select name="area" class="style1" id="area">
                ...
                <option value="5" <? if(isset($_REQUEST['area']) && $_REQUEST['area']==5)echo "selected"?> >RPS</option>
                <option value="6" <? if(isset($_REQUEST['area']) && $_REQUEST['area']==6)echo "selected"?> >SF</option>
  ...
  <tr>
	...
	<td width="50" class="style7" colspan="3"><h3>&nbsp;</h3></td>
		...
		<tr <?=(bcmod($a,2) == 0)?"bgcolor='#DDDDDD'":""?>>
            ...
            if($dListar[3] == 5) echo "RPS";            
            if($dListar[3] == 6) echo "SF";            
