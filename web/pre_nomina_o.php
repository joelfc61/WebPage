                                	...
                                	<table width="100%">
                                    	<tr>
                                        	<td>
                                                ...
                                                <? } if($prenominaMtto){ ?>
                                            	<label ><input type="checkbox"  value="1" name="mantto" >Mantenimiento</label><br><br>
                                                <? } if($prenominaMttob){ ?>
                                            	<label ><input type="checkbox"  value="1" name="manttob" >Mantenimiento B</label><br><br>
                                                <? } if($prenominaEmp){ ?>
                                            	<label ><input type="checkbox"  value="1" name="emp" >Empaque</label><br><br>
                                                <? } if($prenominaEmpb){ ?>
                                            	<label ><input type="checkbox"  value="1" name="empb" >Empaque B</label><br><br>
                                                <? } if($prenominaAlm){ ?>
                                            	<label ><input type="checkbox"  value="1" name="alm" >Almacen</label><br><br>
                                                <? } if($prenominaAlmb){ ?>
                                            	<label ><input type="checkbox"  value="1" name="almb" >Almacen B</label><br><br>
                                                <? } ?>
                                                </td>
                               				</tr>
                                     	</table>
                      ...
                      <? 
                            ...
                            <tr>
                                ...
                                <td><select name="area" >
									...
									<? } if($prenominaMttob){ ?>
									<option value="6">Mantenimiento B</option>
									<? } if($prenominaEmp){ ?>
									<option value="5">Empaque</option>
									<? } if($prenominaEmpb){ ?>
									<option value="7">Empaque B</option>
                                   	<? } if($prenominaAlm){ ?>
									<option value="8">Almacen</option>
									<? } if($prenominaAlmb){ ?>
									<option value="9">Almacen B</option>
									<? } ?>
