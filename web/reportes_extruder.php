...
<? } if($nEntrada > 1 ){ ?>
   		...
   		<tr >
            ...
            <td width="93" align="center" ><h3>Desp.</h3></td>         

            <td width="93" align="center" ><h3>KG/H</h3></td>
  ...
  <?   	while($dEntrada	=	mysql_fetch_row($rEntrada)){ ?>
  		...
  		<tr>
            ...
            <td width="93" align="right" class="style5"><b><?=number_format($total_desper = $dEntrada[2] + $dEntrada[3])?></b></td>
