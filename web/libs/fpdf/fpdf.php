...
var $tmpFiles;		//Para el hack con PNG
...
function HexToRgb($hex)
{
	...
	$rgb['red']		=	intval(hexdec($hex[0].$hex[1]));
	$rgb['green']	=	intval(hexdec($hex[2].$hex[3]));
	$rgb['blue']	=	intval(hexdec($hex[4].$hex[5]));
	return $rgb ;
}
...
{
	/*
		Hack para que reciba colores en formato #RRGGBB
	*/
	if(substr($r,0,1) == "#")
		$r	=	$this->HexToRgb(substr($r,1));
	if(is_array($r))
		$this->DrawColor=sprintf('%.3f %.3f %.3f RG',$r['red']/255,$r['green']/255,$r['blue']/255);
	//Set color for all stroking operations
	else if(($r==0 && $g==0 && $b==0) || $g==-1)
...
function SetFillColor($r,$g=-1,$b=-1)
{
	...
	*/
	if(substr($r,0,1) == "#")
		$r	=	$this->HexToRgb(substr($r,1));
	if(is_array($r))
		$this->FillColor=sprintf('%.3f %.3f %.3f rg',$r['red']/255,$r['green']/255,$r['blue']/255);
...
function SetTextColor($r,$g=-1,$b=-1)
{
	...
	*/
	if(substr($r,0,1) == "#")
		$r	=	$this->HexToRgb(substr($r,1));
	if(is_array($r))
		$this->TextColor=sprintf('%.3f %.3f %.3f rg',$r['red']/255,$r['green']/255,$r['blue']/255);
	//Set color for text
	else if(($r==0 && $g==0 && $b==0) || $g==-1)
