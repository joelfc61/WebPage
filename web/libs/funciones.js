...
////////////// ahora BD
function addTextExtruder_bd(z,x,y,t) 
{
	$j(document).ready(function(){
								
	var obj 		= document.getElementById("texto"+x);

	var contador 	= document.getElementById(y+'_extr_bd'+x).value;

	var textBoxNro 	= y+1;								

		if( document.getElementById(y+'_extr_bd'+x).value != "" && document.getElementById(textBoxNro+'_extr_bd'+x) == null) {
			...
			$j('<table border="0"  cellpadding="0" cellspacing="0"></table>')
				...
				.append(
					...
					.append(	
						...
						$j('<input type="text" class="text" name="ot_extruder_bd'+z+'[]"" id="ot_extruder_bd'+x+'_'+textBoxNro+'" >')
						...
						.append(
							...
							$j('<input type="text" class="text2" name="kg_extruder_bd'+z+'[]" id="'+textBoxNro+'_extr_bd'+x+'" onkeyup="addTextExtruder_bd('+z+','+x+','+textBoxNro+');" onChange=" sumar_bd('+x+');  sumarExtr_bd();  kh('+t+');" >')
			...
			$j('<table></table>')
				...
				.append(
					...
					.append(					
						...
						$j('<td width="80" align="center"></td>')///////////////TROQUEL

						.append(

							$j('<input type="text" class="numeros" name="dtr_'+x+'[]" id="dtr_'+x+'_'+textBoxNro+'" onBlur="sumaLocal('+x+')" onFocus="this.select()" >')

						),

						$j('<td  width="80" align="center"></td>')///////////////SEGUNDAS

						.append(

							$j('<input type="text" class="numeros" name="se_'+x+'[]" id="se_'+x+'_'+textBoxNro+'" onBlur="sumaLocal('+x+')" onFocus="this.select()" ><input type="hidden" name="kam_'+x+'[]" value="0" id="kam_'+x+'_'+textBoxNro+'" onChange="convertir('+x+','+textBoxNro+');" >')
...
function kh_bd(x)
{
		 ...
		 total 		=  document.getElementById('total_extr_bd').value / y;

		 document.getElementById('k_h_bd').value = redondear(total,2);
