...
<tr>              
<td align="center"><h3>MATUTINO</h3></td><td class="style5">Supervisor Mat</td>
...
<td align="center" class="style5"><b>TMMAT</b></td>           
 ...
 <tr">             
 <td align="center"><h3>VESPERTINO</h3></td>  <td class="style5">Supervisor Vesp.</td>              
<td align="center" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=extruder&id_entrada_general=<?=$dEntradaVespertino[3]?>" 
...
<tr>              
<td align="center"><H3>NOCTURNO</H3></td> <TD class="style5">Supervisor Noct.</TD>
<td align="center" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=extruder&id_entrada_general=<?=$dEntradaNocturno[3]?>" 
...
<tr>             
 ...
 <td align="center" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=impresion&id_entrada_general=<?=$dEntradaMatutino2[2]?>" 
...
<td align="center" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=impresion&id_entrada_general=<?=$dEntradaVespertino2[2]?>" 
...
<td align="center" class="style5"><b><?=number_format(100*($total_desperImprV)/($total_desperImprV + $dEntradaVespertino2[0])) ?></b> </td>
 ...
 <td align="center" class="style5"><b>  <a href="<?=$_SERVER['HOST']?>?seccion=33&accion=impresion&id_entrada_general=<?=$dEntradaNocturno2[2]?>" style="text-decoration:none; color:#000000">  <?=number_format($dEntradaNocturno2[0]);?>    </a></b></td>                            
...
<tr>              
<td align="center"><h3>Matutino</h3></td>     
<td class="style5">Supervisor Mat.</td>              
<td align="center" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=bolseo&id_bolseo=<?=$dMaquinasMatutino[5]?>" 
style="text-decoration:none;  color:#000000"><?=number_format($dMaquinasMatutino[1]);?>              </a></b></td>              

<td align="center" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=bolseo&id_bolseo=<?=$dMaquinasMatutino[5]?>" style="text-decoration:none;  color:#000000"> 
<? 
if($real_milla) { 
...
<td width="80" align="center" class="style5"><?=number_format($dMaquinasMatutino[1]/8);?></td>            
<td width="80" align="center" class="style5"><?=number_format($dMaquinasMatutino['2'])?></td>
<? 
    $tot_mp = $dMaquinasMatutino[2] + $dMaquinasMatutino[3]+$dMaquinasMatutino[4]+$kg_reales;
	
?>
<td width="80" align="center" class="style5"><?=number_format(100*$dMaquinasMatutino['2']/$tot_mp,2) ?></td>
<td width="80" align="center" class="style5"><?=number_format($dMaquinasMatutino['3'])?></td>
<td width="80" align="center" class="style5"><?=number_format(100*$dMaquinasMatutino['3']/$tot_mp,2) ?></td>
<td width="80" align="center" class="style5"><?=number_format($dMaquinasMatutino['4']+$vts)?></td>
<td width="80" align="center" class="style5"><?=number_format(100*$dMaquinasMatutino['4']/$tot_mp,2) ?></td>
<td width="80" align="center" class="style5">T.M</td>
</tr>            

<tr>              

<td align="center"><h3>Vespertino</h3></td>              
<td class="style5">Supervisor Vesp.</td>              
<td align="center"><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=bolseo&id_bolseo=<?=$dMaquinasVespertino[5]?>" 
...
<td align="center" class="style5"><?=number_format($dMaquinasVespertino[1]/7)?></td>            
<td width="80" align="center" class="style5"><?=number_format($dMaquinasVespertino['2'])?></td>
<?
$tot_mp = $dMaquinasVespertino[2] + $dMaquinasVespertino[3]+$dMaquinasVespertino[4]+$kg_reales_vesp;
?>
<td width="80" align="center" class="style5"><?=number_format(100*$dMaquinasVespertino[2]/$tot_mp,2) ?></td>
<td width="80" align="center" class="style5"><?=number_format($dMaquinasVespertino['3'])?></td>
<td width="80" align="center" class="style5"><?=number_format(100*$dMaquinasVespertino[3]/$tot_mp,2) ?></td>
<td width="80" align="center" class="style5"><?=number_format($dMaquinasVespertino['4'])?></td>
<td width="80" align="center" class="style5"><?=number_format(100*$dMaquinasVespertino[4]/$tot_mp,2) ?></td>
<td width="80" align="center" class="style5">T.M</td>
</tr>            
<tr>        
<td align="center" class="style5"><h3>Nocturno</h3></td>              
...
?>
<td align="center" class="style5"><?=number_format($dMaquinasNocturno[1]/9)?></td>            
<td width="80" align="center" class="style5"><?=number_format($dMaquinasNocturno['2'])?></td>
<td width="80" align="center" class="style5"><?=number_format(100*$dMaquinasNocturno['2']/$tot_mp,2)?></td>
<td width="80" align="center" class="style5"><?=number_format($dMaquinasNocturno['3'])?></td>
<td width="80" align="center" class="style5"><?=number_format(100*$dMaquinasNocturno['3']/$tot_mp,2)?></td>
<td width="80" align="center" class="style5"><?=number_format($dMaquinasNocturno[4])?></td>
<td width="80" align="center" class="style5"><?=number_format(100*$dMaquinasNocturno['4']/$tot_mp,2)?></td>
<td width="80" align="center" class="style5">T.M</td>
</tr>    
<? 
