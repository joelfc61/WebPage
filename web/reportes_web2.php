...
$ts = mktime(0,0,0,$fecha[mon],$fecha[mday],$fecha[year]) - ADAY;

 //$desde = "2013-01-03";

 $desde = date("Y-m-d",$ts); // "2013-01-03";
...
<tr class="titulos_e">  <td colspan="7"><h3 align="center">PRODUCCION EXTRUDER ALTA DENSIDAD</h3></td></tr>            
<tr>             
...
<tr>              
<td align="center"><h3><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=extruder&id_entrada_general=<?=$dEntradaMatutino[3]?>" style="text-decoration:none; color:#000000">MATUTINO</a></h3></td>
<?
       $qEntradaGeneral	=	"SELECT id_entrada_general, fecha, turno, supervisor.nombre, supervisor.id_supervisor, supervisor.rol FROM entrada_general INNER JOIN supervisor ".
								"ON entrada_general.id_supervisor = supervisor.id_supervisor WHERE (id_entrada_general= $dEntradaMatutino[3])";
...
?>
<td class="style5"><b><?=$dEntradaGeneral['nombre']?></b></td>
<td align="center" class="style5"> <b> 
<?=number_format($dEntradaMatutino[0]);?></b></td>                      
<td align="center" class="style5"><b><?=number_format($total_desper = $dEntradaMatutino[1] + $dEntradaMatutino[2])?></b></td>                      
<td align="center" class="style5"><b><?=number_format(($dEntradaMatutino[3])/($total_desper+$dEntradaMatutino[3]))?></b></td>
<td align="center" class="style5"><b><?=number_format($dEntradaMatutino[0]/8);?></b></td>           
<td align="center" class="style5"><b>TMMAT</b></td>           
 </tr>           
 <tr">             
 <td align="center"><h3><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=extruder&id_entrada_general=<?=$dEntradaVespertino[3]?>" 
style="text-decoration:none; color:#000000">VESPERTINO</a></h3></td> 
<?
$qEntradaGeneral	=	"SELECT id_entrada_general, fecha, turno, supervisor.nombre, supervisor.id_supervisor, supervisor.rol FROM entrada_general INNER JOIN supervisor ".
								"ON entrada_general.id_supervisor = supervisor.id_supervisor WHERE (id_entrada_general= $dEntradaVespertino[3])";
		$rEntradaGeneral	=	mysql_query($qEntradaGeneral); // OR die("<p>$qEntradaGeneral</p><p>".mysql_error()."</p>");
		$dEntradaGeneral	=	mysql_fetch_assoc($rEntradaGeneral);
?>
<td class="style5"><b> <?=$dEntradaGeneral['nombre'] ?></b></td>              
<td align="center" class="style5"><b>  <?=number_format($dEntradaVespertino[0]);?>   </b></td>                      
<td align="center" class="style5"><b><?=number_format($total_desperVesper = $dEntradaVespertino[1] + $dEntradaVespertino[2]);?></b></td>                      
<td align="center" class="style5"><b><?=number_format($total_desperVesper = ($dEntradaVespertino[3])/($total_desperVesper + $dEntradaVespertino[3]));?></b></td>
<td align="center" class="style5"><b><?=number_format($dEntradaVespertino[0]/7);?></b></td>            
<td align="center" class="style5"><b>TMVESP</b></td>
</tr>            
<tr>              
<td align="center"><H3><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=extruder&id_entrada_general=<?=$dEntradaNocturno[3]?>" 
<?
$qEntradaGeneral	=	"SELECT id_entrada_general, fecha, turno, supervisor.nombre, supervisor.id_supervisor, supervisor.rol FROM entrada_general INNER JOIN supervisor ".
								"ON entrada_general.id_supervisor = supervisor.id_supervisor WHERE (id_entrada_general= $dEntradaNocturno[3])";
		$rEntradaGeneral	=	mysql_query($qEntradaGeneral); // OR die("<p>$qEntradaGeneral</p><p>".mysql_error()."</p>");
		$dEntradaGeneral	=	mysql_fetch_assoc($rEntradaGeneral);
?>
style="text-decoration:none; color:#000000">NOCTURNO  </a></H3></td> 
<TD class="style5"><b><?=$dEntradaGeneral['nombre']  ?></b></TD>
<td align="center" class="style5"><b> <?=number_format($dEntradaNocturno[0]);?> </b></td>                      
<td align="center" class="style5"><b><?=number_format($total_despeNocturno = $dEntradaNocturno[1] + $dEntradaNocturno[2])?></b></td> 
<td align="center" class="style5"><b> <?=number_format(100*($total_despeNocturno)/($total_despeNocturno+$dEntradaNocturno[0])) ?></b></td>
<td align="center" class="style5"><b><?=number_format($dEntradaNocturno[0]/9);?></b></td>  
<td align="center" class="style5"><b>TMNOCT</b></td>
</tr>            
<tr>
<td align="center"><h3>Total</h3></td><td align="right" bgcolor="#DDDDDD" class="style5">...</td>              
<td align="center" bgcolor="#DDDDDD" class="style5"><b> <?=number_format($dEntrada[0])?> </b></td>                              
<td align="center" bgcolor="#DDDDDD" class="style5"><b><?=number_format($total_desper = $dEntrada[2] + $dEntrada[3])?></b></td>                              
<td  align="center" bgcolor="#DDDDDD" class="style5"><b><?=number_format(100*($total_desper)/($total_desper+$dEntrada[0])) ?></b></td>
<td align="center" class="style5" bgcolor="#DDDDDD"><b><?=number_format($dEntrada[0]/24);?></b></td>
<td align="center" class="style5" bgcolor="#DDDDDD"><b>TMTOT</b></td>
</tr>          
</table>        
<? 
} 
...
<tr> <td colspan="7"><h3 align="center">PRODUCCION IMPRESION ALTA DENSIDAD</h3></td>       </tr>            
<tr>              
<td width="80" align="center" ><h3>Turno</h3></td>              
<td width="120" align="center" ><h3>SUPERVISOR</h3></td>              
<td width="150"align="center" ><h3>Produccion</h3></td>             
...
<tr>             
 <td width="76" align="center"><h3><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=impresion&id_entrada_general=<?=$dEntradaMatutino2[2]?>" 
style="text-decoration:none; color:#000000">Matutino</a></h3></td> 
<?
        $qEntradaGeneral	=	"SELECT id_entrada_general, fecha, turno, supervisor.nombre, supervisor.id_supervisor, supervisor.rol FROM entrada_general INNER JOIN supervisor ".
								"ON entrada_general.id_supervisor = supervisor.id_supervisor WHERE (id_entrada_general={$dEntradaMatutino2[2]})";
		$rEntradaGeneral	=	mysql_query($qEntradaGeneral);// OR die("<p>$qEntradaGeneral</p><p>".mysql_error()."</p>");
		$dEntradaGeneral	=	mysql_fetch_assoc($rEntradaGeneral);
?>
<td class="style5"><b><?=$dEntradaGeneral['nombre']  ?></b></td>             
 <td align="center" class="style5"><b>   <?=number_format($dEntradaMatutino2[0]);?>      </b></td>  
<td align="center" class="style5"><b><?=number_format($total_desperImprM = $dEntradaMatutino2[1])?></b></td>              
<td align="center" class="style5"><b><?=number_format(100*($total_desperImprM)/($total_desperImprM+$dEntradaMatutino2[0]))  ?></b></td>
<td align="center" class="style5"><b><?=number_format($dEntradaMatutino2[0]/8);?></b></td>            
<td align="center" class="style5"><b>TMMAT</b></td>
</tr>            
<tr>              
<td width="76" align="center"> <h3><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=impresion&id_entrada_general=<?=$dEntradaVespertino2[2]?>" 
style="text-decoration:none; color:#000000">Vespertino </a></h3></td> 
<?
        $qEntradaGeneral	=	"SELECT id_entrada_general, fecha, turno, supervisor.nombre, supervisor.id_supervisor, supervisor.rol FROM entrada_general INNER JOIN supervisor ".
								"ON entrada_general.id_supervisor = supervisor.id_supervisor WHERE (id_entrada_general={$dEntradaVespertino2[2]})";
		$rEntradaGeneral	=	mysql_query($qEntradaGeneral);// OR die("<p>$qEntradaGeneral</p><p>".mysql_error()."</p>");
		$dEntradaGeneral	=	mysql_fetch_assoc($rEntradaGeneral);
?>
 <TD class="style5"><b><?=$dEntradaGeneral['nombre'] ?></b></TD>             
<td align="center" class="style5"><b> <?=number_format($dEntradaVespertino2[0]);?></b></td>              
<td align="center" class="style5"><b><?=number_format($total_desperImprV = $dEntradaVespertino2[1])?></b></td>              
<td align="center" class="style5"><b><?=number_format(100*($total_desperImprV)/($total_desperImprV + $dEntradaVespertino2[0])) ?></b> </td>
 <td align="center" class="style5"><b><?=number_format($dEntradaVespertino2[0]/7);?></b></td>            
 <td align="center" class="style5"><b>TMVESP</b></td>
 </tr>            
 <tr>             
 <td width="76" align="center"><h3> <a href="<?=$_SERVER['HOST']?>?seccion=33&accion=impresion&id_entrada_general=<?=$dEntradaNocturno2[2]?>" style="text-decoration:none; color:#000000">  Nocturno</a></h3></td>   
 <?
        $qEntradaGeneral	=	"SELECT id_entrada_general, fecha, turno, supervisor.nombre, supervisor.id_supervisor, supervisor.rol FROM entrada_general INNER JOIN supervisor ".
								"ON entrada_general.id_supervisor = supervisor.id_supervisor WHERE (id_entrada_general={$dEntradaNocturno2[2]})";
		$rEntradaGeneral	=	mysql_query($qEntradaGeneral);// OR die("<p>$qEntradaGeneral</p><p>".mysql_error()."</p>");
		$dEntradaGeneral	=	mysql_fetch_assoc($rEntradaGeneral);
?>
 <td class="style5"><b><?=$dEntradaGeneral['nombre'] ?></b></td>             
 <td align="center" class="style5"><b> <?=number_format($dEntradaNocturno2[0]);?>    </b></td>                            
<td align="center" class="style5"><b><?=number_format($total_desperImprN = $dEntradaNocturno2[1])?></b></td>              
<td align="center" class="style5"><b><?=number_format(100*($total_desperImprN)/($total_desperImprN+$dEntradaNocturno2[0])) ?></b></td>
<td align="center" class="style5"><b><?=number_format($dEntradaNocturno2[0]/9);?></b></td>
<td align="center" class="style5"><b>TMNOCT</b></td>
</tr>    
<tr>              
<td width="76" align="center"><h3>Total</h3></td>  <td align="right" bgcolor="#DDDDDD" class="style5">...</td>     
<td align="center" bgcolor="#DDDDDD" class="style5"><b>  <?=number_format($dEntrada2[0]);?> </b></td>              
<td align="center" bgcolor="#DDDDDD" class="style5"><b><?=number_format($total_desperImpr = $dEntrada2[2])?></b></td>                        
<td align="center" bgcolor="#DDDDDD" class="style5"><b><?=number_format(100*($total_desperImpr)/($total_desperImpr+$dEntrada[0])) ?></b> </td>
<td align="center" bgcolor="#DDDDDD" class="style5"><b><?=number_format($dEntrada2[0]/24);?></b></td> 
<td align="center" class="style5" bgcolor="#DDDDDD"><b>TMTOT</b></td>
</tr>          
</table>        
<?  
...
<td colspan="12"><h3 align="center">PRODUCCION CAMISETA</h3></td>            </tr>            <tr>              
<td width="80" align="center"><h3>TURNO</h3></td>              
<td width="120" align="center"><h3>SUPERVISOR</h3></td>              
<td width="80" align="center"><h3>Mi</h3></td>              
<td width="80" align="center"><h3>Kg</h3></td>              
<td width="80" align="center"><h3>Mi/H</h3></td>            
<td width="80" align="center"><h3>TIRA</h3></td>
<td width="80" align="center"><h3>%TIRA</h3></td>
<td width="80" align="center"><h3>TROQUEL</h3></td>
<td width="80" align="center"><h3>%TROQUEL</h3></td>
<td width="80" align="center"><h3>SEG</h3></td>
<td width="80" align="center"><h3>%SEG</h3></td>
<td width="80" align="center"><h3>T.MUERTOS</h3></td>
</tr>            
<tr>              
<td align="center"><h3><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=bolseo&id_bolseo=<?=$dMaquinasMatutino[5]?>" style="text-decoration:none;  color:#000000"> Matutino</a></h3></td>     
<?
        $qBolseo	=	"SELECT * FROM bolseo INNER JOIN supervisor ON bolseo.id_supervisor = supervisor.id_supervisor WHERE (id_bolseo={$dMaquinasMatutino[5]})";
		$rBolseo	=	mysql_query($qBolseo);// OR die("<p>$qBolseo</p><p>".mysql_error()."</p>");
		$dBolseo	=	mysql_fetch_assoc($rBolseo);
		
?>
<td class="style5"><b><?=$dBolseo['nombre'] ?></b></td>              
<td align="center" class="style5"><b><?=number_format($dMaquinasMatutino[1]);?></b></td>              
...
<td width="80" align="center" class="style5"><b><?=number_format($dMaquinasMatutino[1]/8);?></b></td>            
<td width="80" align="center" class="style5"><b><?=number_format($dMaquinasMatutino['2'])?></b></td>
<? 
    $tot_mp = $dMaquinasMatutino[2] + $dMaquinasMatutino[3]+$dMaquinasMatutino[4]+$kg_reales;
	
?>
<td width="80" align="center" class="style5"><b><?=number_format(100*$dMaquinasMatutino['2']/$tot_mp,2) ?></b></td>
<td width="80" align="center" class="style5"><b><?=number_format($dMaquinasMatutino['3'])?></b></td>
<td width="80" align="center" class="style5"><b><?=number_format(100*$dMaquinasMatutino['3']/$tot_mp,2) ?></b></td>
<td width="80" align="center" class="style5"><b><?=number_format($dMaquinasMatutino['4']+$vts)?></b></td>
<td width="80" align="center" class="style5"><b><?=number_format(100*$dMaquinasMatutino['4']/$tot_mp,2) ?></b></td>
<td width="80" align="center" class="style5"><b>T.M</b></td>
</tr>            

<tr>              

<td align="center"><h3><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=bolseo&id_bolseo=<?=$dMaquinasVespertino[5]?>"  style="text-decoration:none;  color:#000000">  Vespertino</a></h3></td>              
<?
        $qBolseo	=	"SELECT * FROM bolseo INNER JOIN supervisor ON bolseo.id_supervisor = supervisor.id_supervisor WHERE (id_bolseo={$dMaquinasVespertino[5]})";
		$rBolseo	=	mysql_query($qBolseo);// OR die("<p>$qBolseo</p><p>".mysql_error()."</p>");
		$dBolseo	=	mysql_fetch_assoc($rBolseo);
?>
<td align="center" class="style5"><b><?=$dBolseo['nombre'] ?></b></td>              
<td align="center" class="style5"> <?=number_format($dMaquinasVespertino[1])?>  </td>              
...
<td align="center" class="style5"><b><?=number_format($dMaquinasVespertino[1]/7)?></b></td>            
<td width="80" align="center" class="style5"><b><?=number_format($dMaquinasVespertino['2'])?></b></td>
<?
$tot_mp = $dMaquinasVespertino[2] + $dMaquinasVespertino[3]+$dMaquinasVespertino[4]+$kg_reales_vesp;
?>
<td width="80" align="center" class="style5"><b><?=number_format(100*$dMaquinasVespertino[2]/$tot_mp,2) ?></b></td>
<td width="80" align="center" class="style5"><b><?=number_format($dMaquinasVespertino['3'])?></b></td>
<td width="80" align="center" class="style5"><b><?=number_format(100*$dMaquinasVespertino[3]/$tot_mp,2) ?></b></td>
<td width="80" align="center" class="style5"><b><?=number_format($dMaquinasVespertino['4'])?></b></td>
<td width="80" align="center" class="style5"><b><?=number_format(100*$dMaquinasVespertino[4]/$tot_mp,2) ?></b></td>
<td width="80" align="center" class="style5"><b>T.M</b></td>
</tr>            
<tr>        
<td align="center" class="style5"><h3><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=bolseo&id_bolseo=<?=$dMaquinasNocturno[5]?>" style="text-decoration:none;  color:#000000">Nocturno</a></h3></td>              
<?
        $qBolseo	=	"SELECT * FROM bolseo INNER JOIN supervisor ON bolseo.id_supervisor = supervisor.id_supervisor WHERE (id_bolseo={$dMaquinasNocturno[5]})";
		$rBolseo	=	mysql_query($qBolseo);// OR die("<p>$qBolseo</p><p>".mysql_error()."</p>");
		$dBolseo	=	mysql_fetch_assoc($rBolseo);
?>
<td align="left" class="style5"><b><?=$dBolseo['nombre']  ?></b></td>    
<td align="center" class="style5"><b><?=number_format($dMaquinasNocturno[1])?></b></td>          
<td align="center" class="style5"><b>
...
<?
$tot_mp = $dMaquinasNocturno[2] + $dMaquinasNocturno[3]+$dMaquinasNocturno[4]+$kg_reales_noc;
?>
<td align="center" class="style5"><b><?=number_format($dMaquinasNocturno[1]/9)?></b></td>            
<td width="80" align="center" class="style5"><b><?=number_format($dMaquinasNocturno['2'])?></b></td>
<td width="80" align="center" class="style5"><b><?=number_format(100*$dMaquinasNocturno['2']/$tot_mp,2)?></b></td>
<td width="80" align="center" class="style5"><b><?=number_format($dMaquinasNocturno['3'])?></b></td>
<td width="80" align="center" class="style5"><b><?=number_format(100*$dMaquinasNocturno['3']/$tot_mp,2)?></b></td>
<td width="80" align="center" class="style5"><b><?=number_format($dMaquinasNocturno[4])?></b></td>
<td width="80" align="center" class="style5"><b><?=number_format(100*$dMaquinasNocturno['4']/$tot_mp,2)?></b></td>
<td width="80" align="center" class="style5"><b>T.M</b></td>
</tr>    
<? 
...
?>
<tr>
<td  align="center"><h3>Total</h3></td><td align="center" bgcolor="#DDDDDD" class="style5">...</td>
<td align="center" bgcolor="#DDDDDD" class="style5"><b><?=number_format($dMaquinas2[1]);?></b></td>

<td align="center" bgcolor="#DDDDDD" class="style5"><b><?=number_format($totales)?></b></td>
  
<td align="center" bgcolor="#DDDDDD" class="style5"><?=number_format($dMaquinas2[1]/24);?></td>    
<td width="80" align="center" class="style5"><?=number_format($dMaquinasMatutino[2] +$dMaquinasVespertino[2]+$dMaquinasNocturno[2]) ?></td>
<td width="80" align="center" class="style5">%TI</td>
<td width="80" align="center" class="style5"><?=number_format($dMaquinasMatutino[3] +$dMaquinasVespertino[3]+$dMaquinasNocturno[3]) ?></td>
<td width="80" align="center" class="style5">%TR</td>
<td width="80" align="center" class="style5"><?=number_format($dMaquinasMatutino[4] +$dMaquinasVespertino[4]+$dMaquinasNocturno[4]) ?></td>
<td width="80" align="center" class="style5">%SG</td>
<td width="80" align="center" class="style5">T.M</td>
</tr>   
 </table>    
 <? 
 }
...
$rSegundas = mysql_query($qSegundas);
  ...
  ?>       
  <td valign="top" align="center" width="315px">          
  <table style=" margin:15px;">                          <tr>                            <td width="14%" align="center"><strong>Fecha</strong></td>                            <td width="14%" align="                                                                                                                                                                   center"><strong>Turno</strong></td>                            <td width="18%" align="center"><strong>Total Segundas</strong></td>                          </tr>                            <? 
...
if($real_milla) 
$produc_kilos = $dSelectBolseo['millares'] * $valor_ppm;  
else 
$produc_kilos = $dSelectBolseo['kilogramos'] ;
...
if($dMovimientoEmpaque['turno'] != "" && $dMovimientoEmpaque['turno'] != 0 && ($dMovimientoEmpaque['movimiento'] == 4 || $dMovimientoEmpaque['movimiento'] == 20 )  ) 
echo "Cambio al turno: ".$dMovimientoEmpaque['turno']. ".<br>";

if($dMovimientoEmpaque['movimientos.rol'] != ""  &&  $dMovimientoEmpaque['movimientos.rol'] != 0  && ($dMovimientoEmpaque['movimiento'] == 5 || $dMovimientoEmpaque['movimiento'] == 20 )) 
echo "Cambio al Rol: ".$dMovimientoEmpaque['movimientos.rol'].".<br>";

if($dMovimientoEmpaque['horario'] != ""  && $dMovimientoEmpaque['horario'] != 0 ) 
echo "Cambio de horario: ".$dMovimientoEmpaque['horario'].".<br>";

if($dMovimientoEmpaque['premio'] != ""  && $dMovimientoEmpaque['premio'] != 0 ) 
echo "Lo que proceda con premios.<br>";

if($dMovimientoEmpaque['puntualidad'] != ""  && $dMovimientoEmpaque['puntualidad'] != 0 ) 
echo "Afecta puntualidad.<br>";
...
if($dMovimientoEmpaqueB['nuevo_movimiento'] != "" ) 
echo "Otro movimiento:" .$dMovimientoEmpaqueB['nuevo_movimiento'].".<br>";

if($dMovimientoEmpaqueB['dia'] != "" && $dMovimientoEmpaqueB['dia'] != "0000-00-00" && $dMovimientoEmpaqueB['movimiento'] != 9)
{ 
echo "Fecha a cubrir: "; fecha($dMovimientoEmpaqueB['dia']); echo ".<br>"; 
}

if($dMovimientoEmpaqueB['horas'] != "" && $dMovimientoEmpaqueB['horas']  != 0) 
echo "Tiempo: ".$dMovimientoEmpaqueB['horas'].".<br>";

if($dMovimientoEmpaqueB['cantidad'] != ""  && $dMovimientoEmpaqueB['cantidad']  != 0) 
echo "Cantidad: $".$dMovimientoEmpaqueB['cantidad'].".<br>";

if($dMovimientoEmpaqueB['desde'] != ""  && $dMovimientoEmpaqueB['desde']  != "0000-00-00" && ($dMovimientoEmpaqueB['movimiento'] == 9 || $dMovimientoEmpaqueB['movimiento'] == 20 ))
{ 
echo "Del: "; fecha($dMovimientoEmpaqueB['desde']); 
echo " al ";
}

if($dMovimientoEmpaqueB['hasta'] != ""  && $dMovimientoEmpaqueB['hasta']  != "0000-00-00" && ($dMovimientoEmpaqueB['movimiento'] == 9 || $dMovimientoEmpaqueB['movimiento'] == 20 ) )
{ fecha($dMovimientoEmpaqueB['hasta']); 
echo ".<br>";
}
...
!= 0 && ($dMovimientoEmpaqueB['movimiento'] == 4 || $dMovimientoEmpaqueB['movimiento'] == 20 )) echo "Cambio al turno: ".$dMovimientoEmpaqueB['turno']. ".<br>";

if($dMovimientoEmpaqueB['movimientos.rol'] != ""  && $dMovimientoEmpaqueB['movimientos.rol'] != 0  
...
if($dMovimientoEmpaqueB['horario'] != ""   && $dMovimientoEmpaqueB['horario'] != 0 ) 
echo "Cambio de horario: ".$dMovimientoEmpaqueB['horario'].".<br>";

if($dMovimientoEmpaqueB['premio'] != "" && $dMovimientoEmpaqueB['premio'] != 0 ) 
echo "Lo que proceda con premios.<br>";

if($dMovimientoEmpaqueB['puntualidad'] != ""  && $dMovimientoEmpaqueB['puntualidad'] != 0 ) 
echo "Afecta puntualidad.<br>"; 

if($dMovimientoEmpaqueB['productividad'] != "" && $dMovimientoEmpaqueB['productividad'] != 0 ) 
echo "Afecta productividad.<br>";

if($dMovimientoEmpaqueB['no_premio'] != "" && $dMovimientoEmpaqueB['no_premio'] != 0 ) 
echo "No afectar premio.<br>";

if($dMovimientoEmpaqueB['id_operador2'] != "" && $dMovimientoEmpaqueB['id_operador2'] != 0 ) 
echo "Se arreglo con: <span style='color:#FF0000'>" .$dE2['numnomina']." - " .$dE2['nombre'].".</span><br>";                  ?>                  <label>Motivo:</label><?=$dMovimientoEmpaqueB['motivo'] ?><br></td></tr></table></td>              </tr>                <? } ?>                              <? }  if($numMantenimiento > 0  && $_REQUEST['mantto'] == 1  ){?>        
  <tr>                
...
<td align="center" class="style5"><?=fecha($dMovimientoMantenimiento['fecha'])?></td>               
  ...
  <table width="95%" style="background-color:transparent;"><tr style="background-color:transparent;">
  <td align="justify" class="style5"  style="text-align:justify">                  
  <? 
  if($dMovimientoMantenimiento['nuevo_movimiento'] != "" ) 
  echo "Otro movimiento:" .$dMovimientoMantenimiento['nuevo_movimiento'].".<br>";
...
if($dMovimientoEmpaqueB['dia']  != "" && $dMovimientoEmpaqueB['dia']  != "0000-00-00" && $dMovimientoEmpaqueB['movimiento'] != 9)
{ 
echo "Fecha a cubrir: "; fecha($dMovimientoEmpaqueB['dia']); 
echo ".<br>"; 
}
...
if($dMovimientoEmpaqueB['desde'] != ""  && $dMovimientoEmpaqueB['desde']  
!= "0000-00-00" && ($dMovimientoEmpaqueB['movimiento'] == 9 || $dMovimientoEmpaqueB['movimiento'] == 20 ))
{ 
echo "Del: "; fecha($dMovimientoEmpaqueB['desde']); 
echo " al ";
}

if($dMovimientoEmpaqueB['hasta'] != ""  && $dMovimientoEmpaqueB['hasta'] 
!= "0000-00-00" && ($dMovimientoEmpaqueB['movimiento'] == 9 || $dMovimientoEmpaqueB['movimiento'] == 20 ) ){ fecha($dMovimientoEmpaqueB['hasta']); echo ".<br>";}

if($dMovimientoEmpaqueB['desde_tiempo'] != "" && $dMovimientoEmpaqueB['desde_tiempo'] != "00:00" 
&& ($dMovimientoEmpaqueB['movimiento'] == 23 || $dMovimientoEmpaqueB['movimiento'] == 20 ))
{ 
echo "De la hora :"; $dMovimientoEmpaqueB['desde_tiempo']; 
echo " al ";
}
...
if($mes1 != $mes2 && $mes2 != 1)
{         
	$fechas.= "Del dia ".$dia." de ".$mes[intval($mes1)]." al ".$dia2." de ".$mes[intval($mes2)]." de ".$ano2;    }     if($mes1 != $mes2 && $mes2 == 1)
{         
...
$qMqP =  " SELECT * FROM resumen_maquina_im "." INNER JOIN impresion 
ON resumen_maquina_im.id_impresion  = impresion.id_impresion ".
...
$ultimo_dia = UltimoDia($anho,$meMeta);
$mesFinal = $anho.'-'.$mesMetacero.'-'.$ultimo_dia; 
$qTiemposMaq  =  "SELECT TIME(SUM(mantenimiento)) 
AS mantenimiento ,"." TIME(SUM(falta_personal)) AS falta_personal ,"." TIME(SUM(fallo_electrico))
AS fallo_electrico ,"." TIME(SUM(otras)) AS otras ,"." fecha ,"." maquina.marca, maquina.numero ".

$query." LEFT JOIN maquina ON tiempos_muertos.id_maquina = maquina.id_maquina ".
...
?>
 ...
 <td align="right" class="style5"><? printf("%.2f" ,$dMq['total'])?></td>                                                 <td align="right" class="style5"><? printf("%.2f" ,$metas_maquinas)?></td>                                                 <td align="right" class="style5"><? printf("%.2f" ,$diferencia)?></td>                                            </tr>                                            <? 
$a++;
