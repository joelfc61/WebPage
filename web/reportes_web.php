...
<div align="center" id="tablaimpr">
        ...
        <p class="titulos_reportes" align="center" >PRODUCCION DIARIO DE EXTRUDER, IMPRESION Y BOLSEO<br>
        DEL <?=$dia?> DEL <?=$mes[$mesf]?> DEL <?=$ano?></p>
<form name="metas" action="<?=$_SERVER['PHP_SELF']?>?seccion=<?=$_GET['seccion']?>&accion=nuevo" id="super" method="post" >
  <table width="90%" align="center">
    <tr>
      <td align="center"><? if($_REQUEST['tipo'] == 1 || $_REQUEST['tipo'] == 30){?>
          ...
          <table width="95%" align="center" class="titulos_e" style="margin: 5px 5px;" >
            <tr class="titulos_e">
              <td colspan="11"><h3 align="center">PRODUCCION EXTRUDER</h3></td>
            </tr>
            <tr>
              <td width="76" align="center" ><h3>Turno</h3></td>
              <td width="78" align="center" ><h3>Produccion</h3></td>
              ...
              <td align="center" ><h3>Meta_Desp.</h3></td>
              <td width="72" align="center"><h3>Dif.</h3></td>
              <td width="72" align="center"><h3>Kg/H</h3></td>
            </tr>
            <tr align="right">
              <td width="76"><h3>Matutino</h3></td>
              <td align="right" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=extruder&id_entrada_general=<?=$dEntradaMatutino[3]?>" 		style="text-decoration:none; color:#000000">
                <?=number_format($dEntradaMatutino[0]);?>
              </a></b></td>
              <td align="right" class="style5"><?=number_format($metasMatutino = ($dMetas['total_dia']/24)*8);?></td>
              <td align="right" class="style5"><?=number_format($metasMatutino- $dEntradaMatutino[0]);?></td>
              <td align="center" ><? 
              ...
              <td align="right" class="style5"><?=number_format($Diferencia - $total_desper);?></td>
              <td align="right" class="style5"><?=number_format($dEntradaMatutino[0]/8);?></td>
            </tr>
            <tr align="right">
              <td width="76"><h3>Vepertino</h3></td>
              <td align="right" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=extruder&id_entrada_general=<?=$dEntradaVespertino[3]?>" 	style="text-decoration:none; color:#000000">
                <?=number_format($dEntradaVespertino[0]);?>
              </a></b></td>
            ...
            <tr align="right" >
              ...
              <td align="right" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=extruder&id_entrada_general=<?=$dEntradaNocturno[3]?>"	 	style="text-decoration:none; color:#000000">
                <?=number_format($dEntradaNocturno[0]);?>
              </a></b></td>
            ...
            <tr align="right" >
              ...
              <td align="right" bgcolor="#DDDDDD" class="style5"><b>
                <?=number_format($dEntrada[0])?>
              </b></td>
        ...
        <br>
          ...
          <table width="95%" class=" titulos_i" style="margin: 15px 5px;" align="center">
            <tr>
              <td colspan="11"><h3 align="center">PRODUCCION IMPRESION</h3></td>
            </tr>
            <tr>
            ...
            <tr>
              <td width="76" align="right"><h3>Matutino</h3></td>
              <td align="right" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=impresion&id_entrada_general=<?=$dEntradaMatutino2[2]?>" 	style="text-decoration:none; color:#000000">
                <?=number_format($dEntradaMatutino2[0]);?>
              </a></b></td>
              <td align="right" class="style5"><?=number_format($MetaMatu =($dMetasImp['total_dia']/24)*8);?></td>
              <td align="right" class="style5"><?=number_format($nuevoM = $MetaMatu - $dEntradaMatutino2[0]);?></td>
              <td align="center"><? 
								 $pM = $MetaMatu *.20;
								 $nuevaM	=	$MetaMatu - $pM;
              ...
              <td align="right" class="style5"><?=number_format($DiferenciaImprM = (($dMetasImp['desp_duro_hd']/$ultimo_dia)/24)*8);?></td>
              <td align="right" class="style5"><?=number_format($DiferenciaImprM - $total_desperImprM);?></td>
              <td align="right" class="style5"><?=number_format($dEntradaMatutino2[0]/8);?></td>
            </tr>
            <tr>
              <td width="76" align="right" ><h3>Vepertino</h3></td>
              <td align="right" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=impresion&id_entrada_general=<?=$dEntradaVespertino2[2]?>" 	style="text-decoration:none; color:#000000">
                <?=number_format($dEntradaVespertino2[0]);?>
              </a></b></td>
              <td align="right" class="style5"><?=number_format($MetaVesp = ($dMetasImp['total_dia']/24)*7);?></td>
              <td align="right" class="style5"><?=number_format($nuevoV = $MetaVesp - $dEntradaVespertino2[0]);?></td>
              <td align="center"><? 
								 $pV = $MetaVesp *.20;
								 $nuevaV	=	$MetaVesp - $pV;
								 if(floor($dEntradaVespertino2[0]) < floor($nuevaV) && $dEntradaVespertino2[0] > 0 ) echo '<span style="color:#FF0000">BAJA</span>';
								 else if(floor($dEntradaVespertino2[0]) > floor($nuevaV+($pV*3))) echo '<span style="color:#006600">ALTA</span>';
								 else if(floor($dEntradaVespertino2[0]) == 0) echo '<span style="color:#000000">SIN</span>';
								 else echo "NORMAL";
								 ?>
              </td>
              <td align="right" class="style5"><b><?=number_format($total_desperImprV = $dEntradaVespertino2[1])?></b></td>
              <td align="right" class="style5"><?=number_format($DiferenciaImprV = (($dMetasImp['desp_duro_hd']/$ultimo_dia)/24)*7);?></td>
              <td align="right" class="style5"><?=number_format(  $DiferenciaImprV - $total_desperImprV);?></td>
              <td align="right" class="style5"><?=number_format($dEntradaVespertino2[0]/7);?></td>
            </tr>
            <tr>
              <td width="76" align="right"><h3>Nocturno</h3></td>
              <td align="right" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=impresion&id_entrada_general=<?=$dEntradaNocturno2[2]?>" 	style="text-decoration:none; color:#000000">
                <?=number_format($dEntradaNocturno2[0]);?>
              </a></b></td>
              <td align="right" class="style5"><?=number_format($MetaNoc = ($dMetasImp['total_dia']/24)*9);?></td>
              <td align="right" class="style5"><?=number_format($nuevoN = $MetaNoc - $dEntradaNocturno2[0]);?></td>
              <td align="center"><? 
								 $pN = $metasss *.20;
								 $nuevaN	=	$MetaNoc - $pN;
								 if(floor($dEntradaNocturno2[0]) < floor($nuevaN) && $dEntradaNocturno2[0] > 0 ) echo '<span style="color:#FF0000">BAJA</span>';
								 else if(floor($dEntradaNocturno2[0]) > floor($nuevaN+($pN*3))) echo '<span style="color:#006600">ALTA</span>';
								 else if(floor($dEntradaNocturno2[0]) == 0) echo '<span style="color:#000000">SIN</span>';
								 else echo "NORMAL";
								 ?>
              </td>
              <td align="right" class="style5"><b><?=number_format($total_desperImprN = $dEntradaNocturno2[1])?></b></td>
              <td align="right" class="style5"><?=number_format($DiferenciaImprN = (($dMetasImp['desp_duro_hd']/$ultimo_dia)/24)*9);?></td>
              <td align="right" class="style5"><?=number_format($DiferenciaImprN - $total_desperImprN);?></td>
              <td align="right" class="style5"><?=number_format($dEntradaNocturno2[0]/9);?></td>
            </tr>
            <tr>
              <td width="76" align="right"><h3>Total</h3></td>
              <td align="right" bgcolor="#DDDDDD" class="style5"><b>
                <?=number_format($dEntrada2[0]);?>
              </b></td>
              <td align="right" bgcolor="#DDDDDD" class="style5"><?=number_format($metasss = $dMetasImp['total_dia']);?></td>
              <td align="right" bgcolor="#DDDDDD" class="style5"><?=number_format($nuevo = $metasss - $dEntrada2[0]);?></td>
              <td align="center" bgcolor="#DDDDDD"><? 
								 $porciento2 = $metasss *.20;
								 $nueva2	=	$metasss - $porciento2;
              ...
              <td align="right" bgcolor="#DDDDDD" class="style5"><?=number_format($DiferenciaImpr = ($dMetasImp['desp_duro_hd']/$ultimo_dia));?></td>
              <td align="right" bgcolor="#DDDDDD" class="style5"><?=number_format($total_desperImpr - $DiferenciaImpr);?></td>
        ...
        <br>
          ...
          <? if($nMaquinas2 == 1 ){ $dMaquinas2	= mysql_fetch_row($rMaquinas2); ?>
          <table class="titulos_b" width="95%" style="margin: 15px 5px;" align="center">
            <tr>
              <td colspan="11"><h3 align="center">PRODUCCION BOLSEO</h3></td>
            </tr>
            <tr>
              <td align="center"><h3>Turno</h3></td>
              <td align="center"><h3>Kg</h3></td>
              <td align="center"><h3>Meta_Kg</h3></td>
              <td align="center"><h3>Dif</h3></td>
              <td align="center"><h3>Produccion</h3></td>
              <td align="center"><h3>Kg/H</h3></td>
              <td align="center"><h3>Mi</h3></td>
              <td walign="center"><h3>Meta_Mi</h3></td>
              <td align="center"><h3>Dif.</h3></td>
              <td align="center"><h3>Produccion</h3></td>
              <td align="center"><h3>Mi/H</h3></td>
            </tr>
            <tr>
              ...
              <td align="right" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=bolseo&id_bolseo=<?=$dMaquinasMatutino[5]?>" 	style="text-decoration:none;  color:#000000">
                <? if($real_milla) { 
											...
											} else { $kg_reales = $dMaquinasMatutino[0]; } echo number_format($kg_reales);?>
              </a></b></td>
              <td align="right" class="style5"><?=number_format($metasBolKilM = (($dMetasBolseo['meta_mes_kilo']/$ultimo_dia)/24)*8);?></td>
              <td align="right" class="style5"><?=number_format($nuevasBMK =  $metasBolKilM - $kg_reales);?></td>
              <td align="center"><? 
			...
			?></td>
              ...
              <td align="right" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=bolseo&id_bolseo=<?=$dMaquinasMatutino[5]?>" 	style="text-decoration:none;  color:#000000">
				<?=number_format($dMaquinasMatutino[1]);?>
              </a></b></td>
              <td align="right" class="style5"><?=number_format($metasBolM = (($dMetasBolseo['meta_mes_millar']/$ultimo_dia)/24)*8);?></td>
              <td align="right" class="style5"><?=number_format($nuevasBM = $metasBolM - $dMaquinasMatutino[1]);?></td>
              <td align="center"><?
								 $pbM = $metasBolM *.20;
								 ...
								 ?></td>
              <td width="80" align="right" class="style5"><?=number_format($dMaquinasMatutino[1]/8);?></td>
            </tr>
            <tr>
              <td align="right"><h3>Vespertino</h3></td>
              <td align="right" class="style5"><b><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=bolseo&id_bolseo=<?=$dMaquinasVespertino[5]?>" 	style="text-decoration:none;  color:#000000">
                <? if($real_milla) { 
              ...
              <td align="right" class="style5"><?=number_format($nuevasBV = $metasBolKilBV - $kg_reales_vesp);?></td>
              <td align="center"><? 
	...
	?>
              ...
              <td align="right"><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=bolseo&id_bolseo=<?=$dMaquinasVespertino[5]?>" 	style="text-decoration:none;  color:#000000">
                <?=number_format($dMaquinasVespertino[1])?>
              </a></td>
              <td align="right" class="style5"><?=number_format($metasBolMiV = (($dMetasBolseo['meta_mes_millar']/$ultimo_dia)/24)*7);?></td>
              <td align="right" class="style5"><?=number_format($nuevasBMV = $metasBolMiV - $dMaquinasVespertino[1]);?></td>
              <td align="center"><?
								 $pmv = $metasBolMiV *.20;
            ...
            <tr>
              ...
              <td align="right" class="style5"><?=number_format($nuevasBN =  $metasBolKilN - $kg_reales_noc);?></td>
              <td align="center"><? 
	...
	?>
              ...
              <td align="right"><a href="<?=$_SERVER['HOST']?>?seccion=33&accion=bolseo&id_bolseo=<?=$dMaquinasNocturno[5]?>" 	style="text-decoration:none;  color:#000000">
                <?=number_format($dMaquinasNocturno[1])?>
              </a></td>
              <td align="right" class="style5"><?=number_format($metasBolMN = (($dMetasBolseo['meta_mes_millar']/$ultimo_dia)/24)*9);?></td>
              <td align="right" class="style5"><?=number_format($nuevas = $metasBolMN - $dMaquinasNocturno[1] );?></td>
              <td align="center"><?
	...
	<tr>
		...
		<td align="right" bgcolor="#DDDDDD" class="style5"><?=number_format($nuevas2 = $metasBolKil - $dMaquinas2[0]);?></td>
		<td align="center" bgcolor="#DDDDDD"><? 
			$porciento4 = $metasBolKil *.20;
			$menor2	=	$metasBolKil - $porciento4;
			if((floor($totales) < floor($menor2)) && (floor($totales) > 0) )	echo '<span style="color:#FF0000">BAJA</span>';
			else if(floor($totales) > floor($menor2+($porciento4*3)))	echo '<span style="color:#006600">ALTA</span>';
			else if(floor($totales) == 0)	echo '<span style="color:#000000">SIN</span>';
			else echo "NORMAL";		?></td>
		...
		<td align="right" bgcolor="#DDDDDD" class="style5"><?=number_format($nuevas = $metasBol - $dMaquinas2[1]);?></td>
		<td align="center" bgcolor="#DDDDDD"><?
    ...
    <table class="titulos_b" style="margin: 15px 5px;" width="95%" align="center">
    <tr >
      	<td width="13%" align="center" ><h3>Turno</h3></td>
      	<td width="8%" align="center" ><h3>Tira</h3></td>
      	<td width="8%" align="center" ><h3>Meta</h3></td>
      	<td width="9%" align="center" ><h3>Dif._Tira</h3></td>
     	<td width="11%" align="center" ><h3>Troquel</h3></td>
      	<td width="9%" align="center" ><h3>Meta</h3></td>
      	<td width="12%" align="center" ><h3>Dif_Troquel</h3></td>
      	<td width="11%" align="center" ><h3>Segundas</h3></td>
      	<td width="9%" align="center" ><h3>Meta</h3></td>
      	<td width="10%" align="center" ><h3>Dif._Seg</h3></td>
    </tr>
    <tr>
      	<td align="right" ><h3>Matutino</h3></td>
      	<td align="right" class="style5"><b><?=number_format($dMaquinasMatutino['2'])?></b></td>
      	<td align="right" class="style5"><?=number_format($resultado_tiraM = (($dMetasBolseo['mes_tira']/$ultimo_dia)/24)*8);?></td>
      	<td align="right" class="style5"><?=number_format($TotalTiraM = $resultado_tiraM - $dMaquinasMatutino[2]);?></td>
      	<td align="right" class="style5"><b><?=number_format($dMaquinasMatutino['3'])?></b></td>
      	<td align="right" class="style5"><?=number_format($resultado_troquelM = (($dMetasBolseo['mes_troquel']/$ultimo_dia)/24)*8);?></td>
      	<td align="right" class="style5"><?=number_format($TotalTroquelM = $resultado_troquelM - $dMaquinasMatutino[3]);?></td>
      	<td align="right" class="style5"><b><?=number_format($dMaquinasMatutino['4']+$vts)?></b></td>
      	<td align="right" class="style5"><?=number_format($resultado_segM = (($dMetasBolseo['mes_segunda']/$ultimo_dia)/24)*8);?></td>
      	<td align="right" class="style5"><?=number_format($TotalSegM	=	 $resultado_segM - $dMaquinasMatutino[4]);?></td>
    </tr>
    <tr>
        <td align="right" ><h3>Vespertino</h3></td>
        <td align="right" class="style5"><b><?=number_format($dMaquinasVespertino['2'])?></b></td>
        <td align="right" class="style5"><?=number_format($resultado_tiraV = (($dMetasBolseo['mes_tira']/$ultimo_dia)/24)*7);?></td>
        <td align="right" class="style5"><?=number_format($TotalTiraV = $resultado_tiraV - $dMaquinasVespertino[2] );?></td>
        <td align="right" class="style5"><b><?=number_format($dMaquinasVespertino['3'])?></b></td>
        <td align="right" class="style5"><?=number_format($resultado_troquelV = (($dMetasBolseo['mes_troquel']/$ultimo_dia)/24)*7);?></td>
        <td align="right" class="style5"><?=number_format($TotalTroquelV = $resultado_troquelV -  $dMaquinasVespertino[3]);?></td>
        <td align="right" class="style5"><b><?=number_format($dMaquinasVespertino[4]+$vts)?></b></td>
        <td align="right" class="style5"><?=number_format($resultado_segV = (($dMetasBolseo['mes_segunda']/$ultimo_dia)/24)*7);?></td>
        <td align="right" class="style5"><?=number_format($TotalSegV	= $resultado_segV - $dMaquinasVespertino[4]);?></td>
    </tr>
    <tr>
     	<td align="right"><h3>Nocturno</h3></td>
      	<td align="right" class="style5"><b><?=number_format($dMaquinasNocturno['2'])?></b></td>
      	<td align="right" class="style5"><?=number_format($resultado_tiraN = (($dMetasBolseo['mes_tira']/$ultimo_dia)/24)*9);?></td>
      	<td align="right" class="style5"><?=number_format($TotalTiraN = $resultado_tiraN - $dMaquinasNocturno[2] );?></td>
      	<td align="right" class="style5"><b><?=number_format($dMaquinasNocturno['3'])?></b></td>
      	<td align="right" class="style5"><?=number_format($resultado_troquelN = (($dMetasBolseo['mes_troquel']/$ultimo_dia)/24)*9);?></td>
      	<td align="right" class="style5"><?=number_format($TotalTroquelN =   $resultado_troquelN - $dMaquinasNocturno[3]);?></td>
      	<td align="right" class="style5"><b><?=number_format($dMaquinasNocturno['4']+$vts)?></b></td>
      	<td align="right" class="style5"><?=number_format($resultado_segN = (($dMetasBolseo['mes_segunda']/$ultimo_dia)/24)*9);?></td>
      	<td align="right" class="style5"><?=number_format($TotalSegN	=  $resultado_segN - $dMaquinasNocturno[4]);?></td>
    </tr>
    <?
      $TOTAL1	=	$dMaquinas4['3'];
...
<br><br>
	<table align="center" class="styleTabla">
    <tr>
		<td  align="center"><input type="button" class="button1" name="pfd" value="Formato PDF" onClick="genera()"></td>
	</tr>  
	</table>
...
<div style="background-color:#FFFFFF;" class="navcontainer">
	...
	<?	
		...
		$hasta= preg_replace( "/^\s*([0-9]{1,2})[\/\. -]+([0-9]{1,2})[\/\. -]+([0-9]{1,4})/" , "\\3-\\2-\\1", $_REQUEST['hastaRepe']);
				...
				$qEntradas	=	"SELECT *, repesadas.id_supervisor, repesadas.id_admin  FROM repesadas INNER JOIN entrada_general ON repesadas.id_entrada_general = entrada_general.id_entrada_general".
		...
		<tr>
		  ...
		  <td width="105" align="center" style="color:#000000"><b>Turno</b></td>
				...
				<tr onMouseOver="this.style.backgroundColor='#CCC'"	onmouseout="this.style.backgroundColor='#EAEAEA'" style="cursor:default; background-color:#EAEAEA">
                      <td width="170"><?=preg_replace( "/^\s*([0-9]{1,4})[\/\. -]+([0-9]{1,2})[\/\. -]+([0-9]{1,2})/" , "\\3/\\2/\\1" , $dEntradas['fecha'])?></td>
                  <td width="281" align="left"><?
                   $qNombre	=	"SELECT nombre FROM supervisor WHERE id_supervisor = ".$dEntradas['id_supervisor']."";
				  $rNombre	=	mysql_query($qNombre);
				  $dNombre	=	mysql_fetch_assoc($rNombre);
				  $nNombre	=	mysql_num_rows($rNombre);
				  if($nNombre < 1 && $dEntradas['id_admin'] != 0){
                  $qNombre2	=	"SELECT nombre FROM administrador WHERE id_admin = ".$dEntradas['id_admin']."";
				  $rNombre2	=	mysql_query($qNombre2);
				  $dNombre	=	mysql_fetch_assoc($rNombre2);
				  }
				  				  
				 echo  $dNombre['nombre'];?></td>
                  <td width="105" align="center"><?=$dEntradas['turno']?></td>
                  <td align="center"  ><a href="<?=$_SERVER['PHP_SELF']?>	?seccion=7&id_extruder=<?=$dEntradas['id_entrada_general']?>&id_bolseo=<?=$dEntradas['id_bolseo']?>&accion=ver&turno=<?=$dEntradas['turno']?>">Ver</a></td>
              </tr>
                <?php } 
				}  else { ?>
                <tr>
...
function Blur(elemento, valor, campo, id) {
	...
	if (last != valor)
		myajax.Link('actualiza.php?valor='+valor+'&campo='+campo+'&id='+id+'&tabla=detalle_resumen_maquina_bs&tipo=id_detalle_resumen_maquina_bs');
}

function genera()
{
document.form.action="reportes_pdf.php?tipo=<?=$_REQUEST['tipo']?>&orden=<?=$_REQUEST['orden']?>&modelo=<?=$_REQUEST['modelo'];?>&desdeOrd=<?=$_REQUEST['desdeOrd'];?>&hastaOrd=<?=$_REQUEST['hastaOrd'];?>";
document.form.submit();
 ...
 <div align="center" id="tablaimpr">
   	 	<div class="tablaCentrada" id="tabla_reporte">
        <p class="titulos_reportes" align="center">ORDENES TOTALIZADAS EN BOLSEO</p><br>
        <form name="form" action="<?=$_SERVER['PHP_SELF']?>?seccion=<?=$_REQUEST['seccion']?>" method="post">
          <table width="650px" >
                                  <tr>
                       	  <td colspan="6" align="center"><h3><b>
                            <? if($mes1 == $mes2){ ?>
                            Del dia <?=$dia?> al <?=$dia2?> de <?=$mes[intval($mes2)]?> de <?=$ano2?>
                            <? } ?>
                            <? if($mes1 != $mes2 && $mes2 != 1){ ?>
                            Del dia <?=$dia?> de <?=$mes[intval($mes1)]?> al <?=$dia2?> de <?=$mes[intval($mes2)]?> de <?=$ano2?>
                            <? } ?>
                            <? if($mes1 != $mes2 && $mes2 == 1){ ?>
                            Del dia <?=$dia?> de <?=$mes[intval($mes1)]?> de <?=$ano?> al <?=$dia2?> de <?=$mes[intval($mes2)]?> de <?=$ano2?>
                            <? } ?>                            
                          </b></h3></td>
                         </tr>
          		<tr>
                	<td valign="top" align="center" width="315px">
                         <table style="margin:15px;">
                          <tr>
                            ...
                            <? } } ?>
                            <td width="20%" align="center"><strong>No Orden</strong></td>
                            <td width="19%" align="center"><strong>Total Mi.</strong></td>
                            <td width="18%" align="center"><strong>Total Kg.</strong></td>
                          </tr>
                            <? 
							...
							if(bcmod(intval($color),2) == 0){ 
								...
								echo "bgcolor='".$back."'";
                           	  ...
                           	  <? if($_REQUEST['modelo'] == 2 ){ ?>
                              <td align="center" class="style7"><b><?=preg_replace( "/^\s*([0-9]{1,4})[\/\. -]+([0-9]{1,2})[\/\. -]+([0-9]{1,2})/" , "\\3/\\2/\\1" ,$dOrdenes['fecha'])?></b></td>
                               <? if( $_REQUEST['orden'] != "" ){ ?>
							  ...
							  <? }  ?> 
                              <td align="right" class="style5"><b><?=floor($dOrdenes['millares']);?></b></td>
                              <td align="right" class="style5"><b><?=floor($dOrdenes['kilogramos']);?></b></td>
                          </tr>
                            <? 
                            ...
                            <tr>
                                ...
                                <td align="right" class="style5"><b><?=floor($TotalMillares);?></b></td>
                                <td align="right" class="style5"><b><?=floor($TotalKilos);?></b></td>
                            </tr>
                            <? } ?>
          </table>
          </td>
          <?  if(isset($_REQUEST['segundas'])){

 		 $qSegundas	=	"SELECT turno, SUM(bolseo.segundas) AS segundas, fecha  FROM bolseo ".
						" WHERE bolseo.fecha >= '".$desde."' AND bolseo.fecha <= '".$hasta."' GROUP BY turno, fecha ORDER BY fecha, turno ASC ";

		$rSegundas	= 	mysql_query($qSegundas);	
		  ?>
       <td valign="top" align="center" width="315px">
          <table style=" margin:15px;">
                          ...
                          <tr>
                            <td width="14%" align="center"><strong>Fecha</strong></td>
                            <td width="14%" align="                                                                                                                                                                   center"><strong>Turno</strong></td>
                            <td width="18%" align="center"><strong>Total Segundas</strong></td>
                          </tr>
                            <? 
								for($z = 0; $dSegundas	=	mysql_fetch_assoc($rSegundas);$z++){ ?>
                            <tr <? $color = $z;
							if(bcmod(intval($color),2) == 0){ 
								$back 	= "#DDDDDD";  
								$frente = "#B4C3EC";
                              ...
                              <td align="center" class="style7"><b><?=preg_replace( "/^\s*([0-9]{1,4})[\/\. -]+([0-9]{1,2})[\/\. -]+([0-9]{1,2})/" , "\\3/\\2/\\1" ,$dSegundas['fecha'])?></b></td>
                              <td align="center" class="style7"><b><?=$dSegundas['turno'];?></b></td>
                              <td align="right" class="style5"><b><?=floor($dSegundas['segundas']);?></b></td>
                          </tr>
                            <? 
							$TotalSeg	+=  $dSegundas['segundas']; }
							?>
                            <tr>
                           	  <td colspan="2" align="right">TOTAL:</td>
                                <td align="right" class="style5"><b><?=floor($TotalSeg);?></b></td>
                            </tr>
 ...
 <?  if($_REQUEST['tipo'] == 33 ){  
 	...
 	$meMeta =	$_REQUEST['mes_mp'];
	
	$anho =	$_REQUEST['anho_mp'];
	...
	$qSelectExtruder	=	"SELECT SUM(orden_produccion.total) AS total, ".
	...
	$qSelectImpresion	=	"SELECT SUM(impresion.total_hd) AS total, ".
	...
	if($nImpresion > 0){
	$dSelectImpresion	=	mysql_fetch_assoc($rSelectImpresion);
	$DesperdiciosImpresion	=	$dSelectImpresion['desperdicio1'];
	$porcentajeImpr		=	(($DesperdiciosImpresion*100)/$dSelectImpresion['total']);
	}
	...
	$porcentajeTira	=	(($tira*100)/$dSelectBolseo['kilogramos']);
	$porcentajeTroquel	=	(($troquel*100)/$dSelectBolseo['kilogramos']);
 ...
 <div align="center" id="tablaimpr">
   	 	<div class="tablaCentrada" id="tabla_reporte">
        <p class="titulos_reportes" align="center">CONCENTRADO MENSUAL POR AREAS <br>DE <?=$mes[$meMeta]?> DEL <?=$anho?></p><br><br><br>
        	<table width="100%"> 
            	<? if($nMetasBolseo < 1 || $nMetasImp < 1 || $nMetasBolseo < 1 ){?>
                <tr>
                	<td colspan="13"><p align="center" style="color:#FF0000">NO SE HAN ESTABLECIDO METAS PARA HACER COMPARACIONES CON SU PRODUCCION EN ESTE MES.<br />
                    FAVOR DE INFORMARLE AL ADMINISTRADOR DEL SISTEMA.</p><br /><br /><br />
                ...
                <tr align="center">
                	<td width="75" rowspan="3"></td>
               	  <td colspan="3" class="titulos_e"><h3>Extruder</h3></td>           
           		    <td colspan="3" class="titulos_i"><h3>Impresion</h3></td>
                    <td colspan="6" class="titulos_b"><h3>Camisetas</h3></td>
               </tr>
                <tr>
                  <td width="100" rowspan="2" align="center" valign="bottom" class="total">Producci&oacute;n</td>
           	      ...
           	      <td colspan="4" align="center" valign="bottom" bgcolor="#DDDDDD" class="total">Desperdicio</td>
              </tr>
                <tr>
                	<td width="50" align="center" valign="bottom">Tira</td>
                  <td width="50" align="center" valign="bottom">%</td>
               	  <td width="50" align="center" valign="bottom">Tira</td>
                  <td width="50" align="center" valign="bottom">%</td>  
               	  <td width="50" align="center" valign="bottom">Tira</td>
                  <td width="50" align="center" valign="bottom">%</td>
               	  <td width="50" align="center" valign="bottom">Troquel</td>
                  <td width="50" align="center" valign="bottom">%</td>                    
              </tr>
				<tr>
...
<div align="center" id="tablaimpr">
	<div class="tablaCentrada" id="tabla_reporte">
    <p class=" titulos_reportes" align="center">PAROS REPORTADOS EN TODAS LAS AREAS <br>DE <?=$mes[$meMeta]?> DEL <?=$anho?></p><br>
            <? if(isset($_REQUEST['par_extr'])){?>
    <p align="center" class="subtitulos">Extruder</p> <br>   
     <table width="75%" align="center" class="titulos_e"> 
              <tr align="center">
              	<td width="30%"><H3>Maquina</H3></td>
                <td width="16%"><h3>Mantenimiento</h3></td>    
                <td width="17%"><h3>Falta_de_Opr</h3></td>      
                <td width="12%"><h3>Otro</h3></td>      
                <td width="13%" ><h3>Total</h3></td>
                <td width="12%"><h3>MALLAS</h3></td>      
       </tr> 
             ...
             <? } ?>  
              <tr>
                <td align="right" ><h3>TURNOS_PARADOS:</h3></td>      
            ...
            <? } if(isset($_REQUEST['par_impr'])){?>
    <br><p align="center" class="subtitulos">Impresi&oacute;n</p><br>  
     <table width="75%" align="center" class="titulos_i" style="page-break-after:always"> 
              <tr align="center">
                <td width="25%"><h3>Maquinas</h3></td>      
                <td width="18%"><h3>Mantenimiento</h3></td>      
                <td width="16%"><h3>Falta_de_Opr</h3></td>      
                <td width="14%"><h3>Otro</h3></td>      
            ...
            <? } if(isset($_REQUEST['par_bol'])){?>
    <p class="cabeceras titulos_reportes" align="center">PAROS REPORTADOS EN TODAS LAS AREAS (pagina 2)<br>DE <?=$mes[$meMeta]?> DEL <?=$anho?></p><br>        
    <br><p align="center" class="subtitulos">Camisetas (Bolseo)</p> <br>    
     <table width="75%" align="center">  
              <tr align="center">
                <td width="29%"><h3>Maquinas</h3></td>
                <td width="20%"><h3>Mantenimiento</h3></td>
                <td width="22%"><h3>Falta_de_Opr</h3></td>
                <td width="13%"><h3>Otra</h3></td>
                <td width="16%" colspan="2"><h3>Total</h3></td> 
	   </tr>
              <? 	for($c++; $dSelectBolseo	=	mysql_fetch_assoc($rSelectBolseo); $c++){	
						...
						?>
              <tr <? cebra($c)?>>
                <td ><?=$dSelectBolseo['numero']?> - <?=$dSelectBolseo['marca']?></td>      
                <td align="right" class="style5"><? printf("%.2f ",$dSelectBolseo['mantenimiento']/(24/3))?></td>      
                <td align="right" class="style5"><? printf("%.2f ",$dSelectBolseo['falta_personal']/(24/3))?></td>      
                <td align="right" class="style5"><? printf("%.2f ",$TotalOb/(24/3),1)?></td>      
                <td colspan="2" align="right" class="style5"><? printf("%.2f ",($TotalOb+$dSelectBolseo['falta_personal']+$dSelectBolseo['mantenimiento'])/(24/3))?></td>      
			  </tr>
             <?	 
             ...
             <? } ?>  
              <tr>
                <td align="right" ><h3>TURNOS_PARADOS:</h3></td>      
                <td align="right" class="style4"><? printf("%.2f ",$turnos_manB/(24/3))?></td>      
                <td align="right" class="style4"><? printf("%.2f ",$turnos_perB/(24/3))?></td>      
                <td align="right" class="style4"><? printf("%.2f ",$turnos_falloB/(24/3))?></td>      
                <td colspan="2" align="right" class="style4"><? printf("%.2f ",$turno_totalB/(24/3))?></td>      
			  </tr>
              <tr bgcolor="#EEEEEE">
                <td align="right"><h3>DIAS:</h3></td>      
                <td align="right" class="style5"><? printf("%.2f ",($turnos_manB/24)/$nBolseo)?></td>      
                <td align="right" class="style5"><? printf("%.2f ",($turnos_perB/24)/$nBolseo)?></td>      
                <td align="right" class="style5"><? printf("%.2f ",($turnos_falloB/24)/$nBolseo)?></td>      
                <td colspan="2" align="right" class="style5"><? printf("%.2f ",($Total_extruderB/24)/$nBolseo)?></td>      
			  </tr>  
        </table>
              <? } ?>
  </div>
 ...
 <?  if($_REQUEST['tipo'] == 35 ){  
	...
	$DesperdiciosImpresion	=	$dSelectImpresion['desperdicio1'];
	$porcentajeImpr		=	(($DesperdiciosImpresion*100)/$dSelectImpresion['total']);
	$Total_pi	=	redondeado(  $dMetasImp['porcentaje_desp'] - $porcentajeImpr,2);
	...
	$porcentajeTira	=	(($tira*100)/$dSelectBolseo['kilogramos']);
	$porcentajeTroquel	=	(($troquel*100)/$dSelectBolseo['kilogramos']);
	$Total_pb	=	redondeado( $dMetasBolseo['porcentaje_desp'] - $porcentajeTira ,2);
	$Total_pbt	=	redondeado( $porcentajeTroquel - $dMetasBolseo['porcentaje_troquel'],2);
	$porcentajeTroquel	=	(($troquel*100)/$dSelectBolseo['kilogramos']);
	
	
	
	$total1				= 	redondeado(($dSelectExtruder['total'] * $dMetas['porcentaje_desp'])/100,2);
	$total2				=	redondeado(($dSelectImpresion['total'] *$dMetasImp['porcentaje_desp']) /100,2);
	$total3				=	redondeado(($dSelectBolseo['kilogramos'] * $dMetasBolseo['porcentaje_desp'] )/100,2);
	$total4				=	redondeado(($dSelectBolseo['kilogramos'] * $dMetasBolseo['porcentaje_troquel'] )/100,2);
	
	$Diferencia_TiraE		=	$total1 - $DesperdiciosExtruder;
	$Diferencia_TiraI		=	$total2-$DesperdiciosImpresion;
	$Diferencia_TiraB		=	$total3-$tira;
	$Diferencia_TroquelB	=	$total4-$troquel;

    if($real_milla) $produc_kilos	=	$dSelectBolseo['millares'] * $valor_ppm;  else $produc_kilos	=	$dSelectBolseo['kilogramos'] ;

	$Total_produccion	=	$dSelectExtruder['total'] + $dSelectImpresion['total']+ $produc_kilos ;
	$Total_tira_meta	=	$total1 + $total2 + $total3;
	$Total_tira_por		=	$dMetas['porcentaje_desp']+$dMetasImp['porcentaje_desp']+$dMetasBolseo['porcentaje_desp'];
	$Total_Tira_real	=	$DesperdiciosExtruder + $DesperdiciosImpresion + $tira;
	$Total_tira_porR	=	$PorcentajeExtr + $porcentajeImpr + $porcentajeTira;
	$Total_dif_tira		=	$Diferencia_TiraE + $Diferencia_TiraI +$Diferencia_TiraB;
	$Total_dif_p 		= 	$Total_pe + $Total_pi + $Total_pb;

	?>
<div align="center" id="tablaimpr">
   	 	<div class="tablaCentrada" id="tabla_reporte">
        <br><br><br><p class="titulos_reportes" align="center">DESPERDICIOS CONTRA META POR AREAS DE <?=$mes[$meMeta]?> DEL <?=$anho?></p><br><br><br><br>
			...
			<table width="90%" align="center"> 
               <tr align="center">
                ...
                <tr>
                  <td width="170" align="center" valign="bottom" class="total"></td>
           	      ...
           	      <td colspan="4" align="center" valign="bottom" bgcolor="#DDDDDD" class="total"><h3>DIFERENCIA</h3></td>
              </tr>
                <tr>
                  <td align="center" valign="bottom" class="total"><h3>Producci&oacute;n</h3></td>
                  <td width="91" align="center" valign="middle">Tira</td>
                  <td width="88" align="center" valign="middle">%</td>
               	  <td width="86" align="center" valign="middle">Tira</td>
                  <td width="88" align="center" valign="middle">%</td>  
               	  <td width="94" align="center" valign="middle">Tira</td>
          ...
          <p>&nbsp;</p><br>
			<table width="90%" align="center"> 
                ...
                <tr>
                  <td width="170" align="center" valign="bottom" class="total"><h3>Producci&oacute;n</h3></td>
               	  <td width="91" align="center" valign="middle">Suaje</td>
                  <td width="88" align="center" valign="middle">%</td>
               	  <td width="88" align="center" valign="middle">Suaje</td>
                  <td width="88" align="center" valign="middle">%</td>  
               	  <td width="96" align="center" valign="middle">Suaje</td>
 ...
 <?  if($_REQUEST['tipo'] == 36 ){  
	...
	$meMeta =	$_REQUEST['mes_d'];
	$anho 	=	$_REQUEST['anho_d'];
	$mesMetacero	=	num_mes_cero($anho.'-'.$meMeta.'-01');
	$mesMeta	=	$anho.'-'.$mesMetacero.'-01';
	$ultimo_dia = UltimoDia($anho,$meMeta);
	$mesFinal	=	$anho.'-'.$mesMetacero.'-'.$ultimo_dia;
	...
	$temporal 	= $TOTAL - $DesperdiciosExtruder;
	$Consumo	=	($temporal)/($dSelectExtruder['total'] + $DesperdiciosExtruder);
	}
	

	?>
<div align="center" id="tablaimpr">
	<div class="tablaCentrada" align="center" id="tabla_reporte">
    <br><br><br><p align="center" class="titulos_reportes">DESPERDICIOS MENSUALES<br>DE <?=$mes[$meMeta]?> DEL <?=$anho?> </p><br><br><br><br>
        	<table width="50%"> 
            	<? if($nMetasBolseo < 1 || $nMetasImp < 1 || $nMetasBolseo < 1 ){?>
                <tr>
                	<td colspan="5"><p align="center" style="color:#FF0000">NO SE HAN ESTABLECIDO METAS PARA HACER COMPARACIONES CON SU PRODUCCION EN ESTE MES.<br />
                    FAVOR DE INFORMARLE AL ADMINISTRADOR DEL SISTEMA.</p><br /><br /><br />
                    <p align="left">GRACIAS.</p>                    </td>
                 </tr>
                <? } else { ?>
              <tr>
                  <td width="21%" align="center"><h3>Producci&oacute;n</h3></td>
                ...
                <tr>
                	...
                	<td align="right"  class="style5" ><b><?=number_format($dSelectExtruder['desperdicio2']);?></b></td>
                </tr>
				<tr>
...
<? }
 ...
 <?  if($_REQUEST['tipo'] == 100 ){  
 	$semana =	$_REQUEST['semana_reportes'];
 	$anio_as =	$_REQUEST['anio_nom'];
	
	/*
	$qDelAl	=	"SELECT DAY(desde), DAY(hasta), MONTH(desde), MONTH(hasta), desde, hasta FROM pre_nomina_calificada WHERE semana = ".$semana." AND (YEAR(desde) = '".$anio_as."' || YEAR(hasta) = '".$anio_as."' )  GROUP BY semana";
	...
	*/
	...
	$numExtruder			=	mysql_num_rows($rMovimientoExtruder);
	$numImpresion			=	mysql_num_rows($rMovimientoImpresion);
	$numBolseo				=	mysql_num_rows($rMovimientoBolseo);
	$numEmp					=	mysql_num_rows($rMovimientoEmpaque);
	$numEmpB				=	mysql_num_rows($rMovimientoEmpaqueB);
	$numMantenimiento		=	mysql_num_rows($rMovimientoMantenimiento);
	$numMantenimientoB		=	mysql_num_rows($rMovimientoMantenimientoB);
	$numAlmacen				=	mysql_num_rows($rMovimientoAlmacen);
	$numAlmacenB			=	mysql_num_rows($rMovimientoAlmacenB);
...
function genera()
{
document.form.action="reportes_pdf_nomina.php?tipo=movimiento&area=<?=$_REQUEST['area']?>&movimiento=<?=$_REQUEST['movimiento']?>&semana_reportes=<?=$_REQUEST['semana_reportes']?>&anio_nom=<?=$anio_as?>
<? if(isset($_REQUEST['extruder'])) echo "&extruder=1"; ?>
<? if(isset($_REQUEST['impresion'])) echo "&impresion=1"; ?>
<? if(isset($_REQUEST['bolseo'])) echo "&bolseo=1"; ?>
<? if(isset($_REQUEST['emp'])) echo "&emp=1"; ?>
<? if(isset($_REQUEST['empb']))  echo "&empb=1"; ?>
<? if(isset($_REQUEST['mantto'])) echo "&mantto=1"; ?>
<? if(isset($_REQUEST['manttob'])) echo "&manttob=1"; ?>
<? if(isset($_REQUEST['alm'])) echo "&alm=1"; ?>
<? if(isset($_REQUEST['almb'])) echo "&almb=1"; ?>";
document.form.submit();

}
</script>
   	 	<div class="tablaCentrada" align="center">
        <form name="form" action="reportes_pdf_nomina.php" method="post">
        	<table width="70%" border="0" cellpadding="1" cellspacing="1" align="center"> 
            <tr>
            	<td colspan="10" align="center" style="font-size:12px"><? if($_REQUEST['movimiento'] == 1) echo "MOVIMIENTOS NORMALES"; else if($_REQUEST['movimiento'] == 2) echo "MOVIMIENTOS ECONOMICOS"; else if($_REQUEST['movimiento'] == 3) echo "MOVIMIENTOS NORMALES";?></td>
            </tr>
            <? if( $numExtruder > 0 &&  $_REQUEST['extruder'] == 1 ){?>
       	  <tr>
                	<td colspan="5" align="center"><h3>EXTRUDER</h3></td>
                </tr>
 				<tr>
                  <td width="8%" align="center"><h3>Fecha</h3></td>
               	  ...
               	  <td width="41%" align="center"><h3>Motivo</h3></td>
              </tr>
                ...
                <? for($a = 0; $dMovimientoExtruder = mysql_fetch_assoc($rMovimientoExtruder) ;$a++){
 				...
 				<tr <? if(bcmod($a,2) == 0) echo "bgcolor='#DDDDDD'"; else echo "";?>>
                  ...
                  <table width="96%" style="background-color:transparent;">
                    <tr style="background-color:transparent;"><td align="justify" class="style5"  style="text-align:justify">
                  <? if($dMovimientoExtruder['nuevo_movimiento'] != "" ) echo "Otro movimiento:" .$dMovimientoExtruder['nuevo_movimiento'].".<br>";
								...
								if($dMovimientoExtruder['turno'] != "" && $dMovimientoExtruder['turno'] != 0 && ($dMovimientoExtruder['movimiento'] == 4 || $dMovimientoExtruder['movimiento'] == 20 )) echo "Cambio al turno: ".	$dMovimientoExtruder['turno']. ".<br>";
								...
								if($dMovimientoExtruder['id_operador2'] != "" && $dMovimientoExtruder['id_operador2'] != 0 ) echo "Se arreglo con: <span style='color:#FF0000'>" .$dE2['numnomina']." - " .$dE2['nombre'].".</span><br>";
                  ?>
                  <label>Motivo:</label><?=$dMovimientoExtruder['motivo'] ?></td></tr></table></td>
              </tr>
                <? } ?>		
...
<h3>IMPRESION</h3></td>
 				...
 				<tr>
                	<td width="8%" align="center"><h3>Fecha</h3></td>
               	  ...
               	  <td width="27%" align="center"><h3>Nombre</h3></td>
               	  <td width="15%" align="center"><h3>Movimiento</h3></td>
               	  <td width="41%" align="center"><h3>Caracteristicas</h3></td>
              </tr>
				...
				?>
 				<tr <? if(bcmod($a,2) == 0) echo "bgcolor='#DDDDDD'"; else echo "";?>>
                	<td align="center" class="style5"><?=fecha($dMovimientoImpresion['fecha'])?></td>
               	  ...
               	  <td  align="justify" width="41%"  class="style5"  style="text-align:justify">
                  <table width="95%" style="background-color:transparent;"><tr style="background-color:transparent;"><td align="justify" class="style5"  style="text-align:justify">
                  <? if($dMovimientoImpresion['nuevo_movimiento'] != "" ) echo "Otro movimiento:" .$dMovimientoImpresion['nuevo_movimiento'].".<br>";
								...
								if($dMovimientoImpresion['turno'] != "" && $dMovimientoImpresion['turno'] != 0 && ($dMovimientoImpresion['movimiento'] == 4 || $dMovimientoImpresion['movimiento'] == 20 )  ) echo "Cambio al turno: ".	$dMovimientoImpresion['turno']. ".<br>";
								...
								if($dMovimientoImpresion['id_operador2'] != ""   && $dMovimientoImpresion['id_operador2'] != 0 ) echo "Se arreglo con: <span style='color:#FF0000'>" .$dE2['numnomina']." - " .$dE2['nombre'].".</span><br>";
                  ?>
                  <label>Motivo:</label><?=$dMovimientoImpresion['motivo'] ?><br></td></tr></table></td>
              </tr>
                <? } ?>	
				...
				?>
 				<tr <? if(bcmod($a,2) == 0) echo "bgcolor='#DDDDDD'"; else echo "";?>>
				  ...
				  <table width="95%" style="background-color:transparent;"><tr style="background-color:transparent;"><td align="justify" class="style5"  style="text-align:justify">                  <? if($dMovimientoBolseo['nuevo_movimiento'] != "" ) echo "Otro movimiento:" .$dMovimientoBolseo['nuevo_movimiento'].".<br>";
								...
								if($dMovimientoBolseo['turno'] != "" && $dMovimientoBolseo['turno'] != 0 && ($dMovimientoBolseo['movimiento'] == 4 || $dMovimientoBolseo['movimiento'] == 20 )) echo "Cambio al turno: ".	$dMovimientoBolseo['turno']. ".<br>";
								...
								if($dMovimientoBolseo['id_operador2'] != "" && $dMovimientoBolseo['id_operador2'] != 0 ) echo "Se arreglo con: <span style='color:#FF0000'>" .$dE2['numnomina']." - " .$dE2['nombre'].".</span><br>";
                  ?>
                  <label>Motivo:</label><?=$dMovimientoBolseo['motivo'] ?><br>                  
                  </td></tr></table></td>
              </tr>
              <? } 
				...
				?>
 				<tr <? if(bcmod($a,2) == 0) echo "bgcolor='#DDDDDD'"; else echo "";?>>
                  ...
                  <? 			if($dMovimientoEmpaque['nuevo_movimiento'] != "" ) echo "Otro movimiento:" .$dMovimientoEmpaque['nuevo_movimiento'].".<br>";
								...
								if($dMovimientoEmpaque['turno'] != "" && $dMovimientoEmpaque['turno'] != 0 && ($dMovimientoEmpaque['movimiento'] == 4 || $dMovimientoEmpaque['movimiento'] == 20 )  ) echo "Cambio al turno: ".	$dMovimientoEmpaque['turno']. ".<br>";
								...
								if($dMovimientoEmpaque['id_operador2'] != "" && $dMovimientoEmpaque['id_operador2'] != 0 ) echo "Se arreglo con: <span style='color:#FF0000'>" .$dE2['numnomina']." - " .$dE2['nombre'].".</span><br>";
                  ?>
                  <label>Motivo:</label><?=$dMovimientoEmpaque['motivo'] ?><br></td></tr></table></td>
              </tr>
                <? } ?>	
				...
				?>
 				<tr <? if(bcmod($a,2) == 0) echo "bgcolor='#DDDDDD'"; else echo "";?>>
                  ...
                  <? 			if($dMovimientoEmpaqueB['nuevo_movimiento'] != "" ) echo "Otro movimiento:" .$dMovimientoEmpaqueB['nuevo_movimiento'].".<br>";
								if($dMovimientoEmpaqueB['dia'] 				!= "" 	&& $dMovimientoEmpaqueB['dia'] 			!= "0000-00-00" && $dMovimientoEmpaqueB['movimiento'] != 9){ echo "Fecha a cubrir: "; fecha($dMovimientoEmpaqueB['dia']); echo ".<br>"; }
								if($dMovimientoEmpaqueB['horas'] 			!= "" 	&& $dMovimientoEmpaqueB['horas'] 		!= 0) echo "Tiempo: ".$dMovimientoEmpaqueB['horas'].".<br>";
								if($dMovimientoEmpaqueB['cantidad'] 		!= "" 	&& $dMovimientoEmpaqueB['cantidad'] 	!= 0) echo "Cantidad: $".$dMovimientoEmpaqueB['cantidad'].".<br>";
								if($dMovimientoEmpaqueB['desde'] 			!= "" 	&& $dMovimientoEmpaqueB['desde'] 		!= "0000-00-00" && ($dMovimientoEmpaqueB['movimiento'] == 9 || $dMovimientoEmpaqueB['movimiento'] == 20 )){ echo "Del: "; fecha($dMovimientoEmpaqueB['desde']); echo " al ";}
								if($dMovimientoEmpaqueB['hasta'] 			!= "" 	&& $dMovimientoEmpaqueB['hasta'] 		!= "0000-00-00" && ($dMovimientoEmpaqueB['movimiento'] == 9 || $dMovimientoEmpaqueB['movimiento'] == 20 ) ){ fecha($dMovimientoEmpaqueB['hasta']); echo ".<br>";}
								if($dMovimientoEmpaqueB['desde_tiempo'] 	!= "" 	&& $dMovimientoEmpaqueB['desde_tiempo'] != "00:00" 		&& ($dMovimientoEmpaqueB['movimiento'] == 23 || $dMovimientoEmpaqueB['movimiento'] == 20 )){ echo "De la hora :"; $dMovimientoEmpaqueB['desde_tiempo']; echo " al ";}
								if($dMovimientoEmpaqueB['hasta_tiempo'] 	!= "" 	&& $dMovimientoEmpaqueB['hasta_tiempo'] != "00:00" 		&& ($dMovimientoEmpaqueB['movimiento'] == 23 || $dMovimientoEmpaqueB['movimiento'] == 20 )){ echo "hasta la hora :"; $dMovimientoEmpaqueB['hasta_tiempo']; echo ".<br>";}
								if($dMovimientoEmpaqueB['turno'] 			!= "" 	&& $dMovimientoEmpaqueB['turno'] 		!= 0 			&& ($dMovimientoEmpaqueB['movimiento'] == 4 || $dMovimientoEmpaqueB['movimiento'] == 20 )) echo "Cambio al turno: ".$dMovimientoEmpaqueB['turno']. ".<br>";
								if($dMovimientoEmpaqueB['movimientos.rol'] 				!= ""  	&& $dMovimientoEmpaqueB['movimientos.rol'] 			!= 0  			&& ($dMovimientoEmpaqueB['movimiento'] == 5 || $dMovimientoEmpaqueB['movimiento'] == 20 )) echo "Cambio al Rol: ".$dMovimientoEmpaqueB['movimientos.rol'].".<br>";
								if($dMovimientoEmpaqueB['horario'] 			!= ""  	&& $dMovimientoEmpaqueB['horario'] 		!= 0 ) echo "Cambio de horario: ".$dMovimientoEmpaqueB['horario'].".<br>";
								if($dMovimientoEmpaqueB['premio'] 			!= "" 	&& $dMovimientoEmpaqueB['premio'] 		!= 0 ) echo "Lo que proceda con premios.<br>";
								if($dMovimientoEmpaqueB['puntualidad'] 		!= "" 	&& $dMovimientoEmpaqueB['puntualidad'] 	!= 0 ) echo "Afecta puntualidad.<br>"; 
								if($dMovimientoEmpaqueB['productividad'] 	!= "" 	&& $dMovimientoEmpaqueB['productividad'] != 0 ) echo "Afecta productividad.<br>";
								if($dMovimientoEmpaqueB['no_premio'] 	!= "" 	&& $dMovimientoEmpaqueB['no_premio'] != 0 ) echo "No afectar premio.<br>";
								if($dMovimientoEmpaqueB['id_operador2'] 	!= "" 	&& $dMovimientoEmpaqueB['id_operador2'] != 0 ) echo "Se arreglo con: <span style='color:#FF0000'>" .$dE2['numnomina']." - " .$dE2['nombre'].".</span><br>";
                  ?>
                  <label>Motivo:</label><?=$dMovimientoEmpaqueB['motivo'] ?><br></td></tr></table></td>
              </tr>
                <? } ?>              
				...
				?>
 				<tr <? if(bcmod($a,2) == 0) echo "bgcolor='#DDDDDD'"; else echo "";?>>
                	<td align="center" class="style5"><?=fecha($dMovimientoMantenimiento['fecha'])?></td>
               	  ...
               	  <td  align="justify" width="41%"  class="style5"  style="text-align:justify">
                  <table width="95%" style="background-color:transparent;"><tr style="background-color:transparent;"><td align="justify" class="style5"  style="text-align:justify">
                  <? if($dMovimientoMantenimiento['nuevo_movimiento'] != "" ) echo "Otro movimiento:" .$dMovimientoMantenimiento['nuevo_movimiento'].".<br>";
								...
								if($dMovimientoMantenimiento['turno'] != "" && $dMovimientoMantenimiento['turno'] != 0 && ($dMovimientoMantenimiento['movimiento'] == 4 || $dMovimientoMantenimiento['movimiento'] == 20 )  ) echo "Cambio al turno: ".	$dMovimientoMantenimiento['turno']. ".<br>";
								...
								if($dMovimientoMantenimiento['id_operador2'] != "" && $dMovimientoMantenimiento['id_operador2'] != 0 ) echo "Se arreglo con: <span style='color:#FF0000'>" .$dE2['numnomina']." - " .$dE2['nombre'].".</span><br>";
                  ?>
                  <label>Motivo:</label><?=$dMovimientoMantenimiento['motivo'] ?><br></td></tr></table></td>
              </tr>
                <? } ?>	            
				...
				?>
 				<tr <? if(bcmod($a,2) == 0) echo "bgcolor='#DDDDDD'"; else echo "";?>>
                  ...
                  <? 			if($dMovimientoMantenimientoB['nuevo_movimiento'] != "" ) echo "Otro movimiento:" .$dMovimientoMantenimientoB['nuevo_movimiento'].".<br>";
								...
								if($dMovimientoMantenimientoB['turno'] != "" && $dMovimientoMantenimientoB['turno'] != 0 && ($dMovimientoMantenimientoB['movimiento'] == 4 || $dMovimientoMantenimientoB['movimiento'] == 20 )  ) echo "Cambio al turno: ".	$dMovimientoMantenimientoB['turno']. ".<br>";
								...
								if($dMovimientoMantenimientoB['id_operador2'] != "" && $dMovimientoMantenimientoB['id_operador2'] != 0 ) echo "Se arreglo con: <span style='color:#FF0000'>" .$dE2['numnomina']." - " .$dE2['nombre'].".</span><br>";
                  ?>
                  <label>Motivo:</label><?=$dMovimientoMantenimientoB['motivo'] ?><br></td></tr></table></td>
              </tr>
				...
				?>
 				<tr <? if(bcmod($a,2) == 0) echo "bgcolor='#DDDDDD'"; else echo "";?>>
                  ...
                  <? 			if($dMovimientoAlmacen['nuevo_movimiento'] != "" ) echo "Otro movimiento:" .$dMovimientoAlmacen['nuevo_movimiento'].".<br>";
								...
								if($dMovimientoAlmacen['turno'] != "" && $dMovimientoAlmacen['turno'] != 0 && ($dMovimientoAlmacen['movimiento'] == 4 || $dMovimientoAlmacen['movimiento'] == 20 )  ) echo "Cambio al turno: ".	$dMovimientoAlmacen['turno']. ".<br>";
								...
								if($dMovimientoAlmacen['id_operador2'] != "" && $dMovimientoAlmacen['id_operador2'] != 0 ) echo "Se arreglo con: <span style='color:#FF0000'>" .$dE2['numnomina']." - " .$dE2['nombre'].".</span><br>";
                  ?>
                  <label>Motivo:</label><?=$dMovimientoAlmacen['motivo'] ?><br></td></tr></table></td>
              </tr>
				...
				?>
 				<tr <? if(bcmod($a,2) == 0) echo "bgcolor='#DDDDDD'"; else echo "";?>>
                  ...
                  <? 			if($dMovimientoAlmacenB['nuevo_movimiento'] != "" ) echo "Otro movimiento:" .$dMovimientoAlmacenB['nuevo_movimiento'].".<br>";
								...
								if($dMovimientoAlmacenB['turno'] != "" && $dMovimientoAlmacenB['turno'] != 0 && ($dMovimientoAlmacenB['movimiento'] == 4 || $dMovimientoAlmacenB['movimiento'] == 20 )  ) echo "Cambio al turno: ".	$dMovimientoAlmacenB['turno']. ".<br>";
								...
								if($dMovimientoAlmacenB['id_operador2'] != "" && $dMovimientoAlmacenB['id_operador2'] != 0 ) echo "Se arreglo con: <span style='color:#FF0000'>" .$dE2['numnomina']." - " .$dE2['nombre'].".</span><br>";
                  ?>
                  <label>Motivo:</label><?=$dMovimientoAlmacenB['motivo'] ?><br></td></tr></table></td>
              </tr>
                <? }   ?>                                
...
<? }  if($_REQUEST['movimiento'] == 3){ 
	...
	$qMovimientoMantenimientoB	=	"SELECT * FROM movimientos INNER JOIN operadores ON movimientos.id_operador = operadores.id_operador WHERE semana = $semana AND YEAR(fecha) = '".$anio_as."' AND area = 6 AND almacen = 0 AND ( movimiento = 10 OR movimiento = 11) AND autorizado = 1 ORDER BY fecha, numnomina ASC";
	$qMovimientoAlmacen			=	"SELECT * FROM movimientos INNER JOIN operadores ON movimientos.id_operador = operadores.id_operador WHERE semana = $semana AND YEAR(fecha) = '".$anio_as."' AND ( area = 8 OR almacen = 1 ) AND ( movimiento = 10 AND movimiento = 11) AND autorizado = 1 ORDER BY fecha, numnomina ASC";
	$qMovimientoAlamcenB		=	"SELECT * FROM movimientos INNER JOIN operadores ON movimientos.id_operador = operadores.id_operador WHERE semana = $semana AND YEAR(fecha) = '".$anio_as."' AND ( area = 9  ) AND ( movimiento = 10 AND movimiento = 11) AND autorizado = 1 ORDER BY fecha, numnomina ASC";
...
?>
<? if( $numExtruder > 0 || $numImpresion > 0 || $numBolseo > 0 ||$numEmp > 0 || $numEmpB > 0 ||$numMantenimiento > 0 ||$numMantenimientoB  > 0 || $numAlmacen > 0 || $numAlmacenB > 0){ ?>
            <tr>
            	<td colspan="10" align="center" style="font-size:12px"><br><br><br>MOVIMIENTOS ECONOMICOS</td>
            </tr>
       <? } ?>
            <? if( $numExtruder > 0 &&  $_REQUEST['extruder'] == 1 ){?>
       	  <tr>
...
<? }  } if($numExtruder < 1 || $numImpresion < 1 || $numBolseo < 1 || $numEmp < 1 || $numEmpB < 1 || $numMantenimiento < 1 || $numMantenimientoB < 1){ ?>
			<tr>
            	<td colspan="5" class="style4" align="center"><br>
<br>
<br>
	</td>
            </tr>                 
            ...
            <tr><td colspan="5" align="center"><input type="button" name="pfd" value="Formato PDF" class="button1" onClick="genera()"></td></tr>
           </table></form>
<?
}?>
...
if($area == 1){
echo  $qReportes	=	"SELECT id_orden_produccion, turno, id_supervisor, orden_produccion.observaciones, fecha FROM entrada_general INNER JOIN orden_produccion ON entrada_general.id_entrada_general = orden_produccion.id_entrada_general".
					" WHERE fecha BETWEEN '".$fecha."' AND '".$fechaFin."' ORDER BY fecha, turno ASC";
}

if($area == 2){
 $qReportes	=	"SELECT id_impresion, turno, id_supervisor, impresion.observaciones FROM entrada_general INNER JOIN impresion ON entrada_general.id_entrada_general = impresion.id_entrada_general".
					" WHERE fecha BETWEEN '".$fecha."' AND '".$fechaFin."' ORDER BY turno ASC";
}

if($area == 4){
echo  $qReportes	=	"SELECT id_bolseo, turno, id_supervisor, observaciones FROM bolseo ".
					" WHERE fecha BETWEEN '".$fecha."' AND '".$fechaFin."' ORDER BY turno ASC";
}
...
function genera()
{
document.form.action="reportes_pdf.php?tipo=<?=$_REQUEST['tipo']?>&fecha_incidencia=<?=$_REQUEST['fecha_incidencia']?>";
document.form.submit();
...
<div align="center">
   ...
   <table border="0" width="100%" align="center" cellpadding="1" cellspacing="1">
   				<tr>
                    <td colspan="2" align="center" width="100%"><? if($_REQUEST['tipo'] == 14) echo " EXTRUDER"; else if($_REQUEST['tipo'] == 15) echo " IMPRESION"; else if($_REQUEST['tipo'] == 16) echo " BOLSEO"; ?></td>
 				 </tr>
                 <tr>
               	   <td align="left" width="11%"><h3>Fecha : </h3></td><td width="79%"><?=$_REQUEST['fecha_incidencia']?></td>
                </tr>
   </table>
            ...
            <table border="0" width="100%" align="center" cellpadding="1" cellspacing="1">
  				<tr>
                	<td colspan="7" align="center" class="style7">REPORTE TURNO <?=$turno?></td>
                </tr>
                <tr>
                ...
                <tr>
				  ...
				  <td width="35%" align="center"><h3>Observaciones</h3></td>
					...
					<? if($area == 2){ ?>
                   <tr>
                   	<td colspan="8" align="left" ><br><label>Lineas de impresion</label><br></td>
                   </tr> 
                ...
                <tr>
                	<td colspan="7" align="center"><br><br><bR></td>
                </tr>
...
$meses	=	$_REQUEST['mes_t_des'];
$anio	=	$_REQUEST['ano_t_des'];
...
for($t = 0; $dExtruder = mysql_fetch_assoc($rExtruder);$t++){
		...
		$diferencia[$t]	=	($produccion[$t] - $dMetas['total_dia']);
...
<div align="center" id="tablaimpr">
	<div class="tablaCentrada" align="center" id="tabla_reporte">
    <br><br><br><p align="center" class="titulos_reportes">Desperdicios Total Turno <?=$mes[$meMeta]?> DEL <?=$anho?> </p><br><br><br><br>
<form name="form" action="<?=$_SERVER['PHP_SELF']?>&seccion=<?=$_REQUEST['seccion']?>" method="post">
        <table width="80%" align="center" >
            <tr>
                <td width="18%" align="center" valign="middle" ><h3 style="height:25px;">Fecha</h3></td>
                <td width="30%" height="60px" align="center"><h3 style="height:25px;">Prod. Diaria</h3></td>
                <td width="29%" height="60px" align="center"><h3 style="height:25px;">Meta Diaria</h3></td>
                <td width="23%" height="60px" align="center"><h3 style="height:25px;">Dif.</h3></td>
            </tr>
            <? for($t = 0; $t < sizeof($produccion);$t++){?>
            <tr <?=cebra($t)?>>
                <td class="style5" align="center"><?=fecha($fecha[$t])?></td>
                <td class="style5" align="right"><?=$produccion[$t]?></td>
                <td class="style5" align="right"><?=$dMetas['total_dia'];?></td>
                <td class="style5" align="right"><?=$diferencia[$t]?></td>
            </tr> 
            <? } ?>
...
<script language="javascript" src="js/isiAJAX.js"></script>
<? if($_REQUEST['formaR'] == 1) $opc = 'tabla=detalle_resumen_maquina_ex&tipo=id_detalle_resumen_maquina_ex';
   if($_REQUEST['formaR'] == 2) $opc = 'tabla=detalle_resumen_maquina_im&tipo=id_detalle_resumen_maquina_im';
?>
<script language="javascript">
var last;
function Focus(elemento, valor) {
...
function Blur(elemento, valor, campo, id) {
	$(elemento).className = 'inputoff';
	if (last != valor)
		myajax.Link('actualiza.php?valor='+valor+'&campo='+campo+'&id='+id+'&<?=$opc?>');
}
...
<!-- <body onLoad="myajax = new isiAJAX();"> -->
 <? 
	...
	($_REQUEST['formaR'] == 1)?$titulacho	=	"EXTRUDER":"";
	($_REQUEST['formaR'] == 2)?$titulacho	=	"IMPRESION":"";
	($_REQUEST['formaR'] == 3)?$titulacho	=	"COMPARATIVO EXTRUDER E IMPRESION":"";
	
	
	if( ($_REQUEST['modeloExt'] == 2 && $_REQUEST['ordenExt'] != "" && $_REQUEST['formaR'] == 1) ||  ($_REQUEST['modeloExt'] == 2 && $_REQUEST['ordenExt'] != "" && $_REQUEST['formaR'] == 3) ){
 	$qOrdenes	=	" SELECT SUM(detalle_resumen_maquina_ex.kilogramos) AS kilogramos, entrada_general.fecha, detalle_resumen_maquina_ex.orden_trabajo, entrada_general.turno, detalle_resumen_maquina_ex.id_detalle_resumen_maquina_ex, maquina.numero FROM orden_produccion ".
	...
	if( ($_REQUEST['modeloExt'] == 2 && $_REQUEST['ordenExt'] != "" && $_REQUEST['formaR'] == 2) ||  ($_REQUEST['modeloExt'] == 2 && $_REQUEST['ordenExt'] != "" && $_REQUEST['formaR'] == 3) ){
 	$qOrdenesI	=	" SELECT SUM(detalle_resumen_maquina_im.kilogramos) AS kilogramos, entrada_general.fecha, detalle_resumen_maquina_im.orden_trabajo, entrada_general.turno, detalle_resumen_maquina_im.id_detalle_resumen_maquina_im, maquina.numero FROM impresion ".
	...
	$rOrdenesI	= 	mysql_query($qOrdenesI);	
	...
	$fechas	=	"";
  	...
  	if($mes1 == $mes2)
	{ 
  		$fechas	.= "Del dia ".$dia." al ".$dia2." de ".$mes[intval($mes2)]." de ".$ano2;
  	} 
	if($mes1 != $mes2 && $mes2 != 1)
	{ 
        $fechas	.= "Del dia ".$dia." de ".$mes[intval($mes1)]." al ".$dia2." de ".$mes[intval($mes2)]." de ".$ano2;
    } 
    if($mes1 != $mes2 && $mes2 == 1)
	{ 
        $fechas	.= "Del dia ".$dia." de ".$mes[intval($mes1)]." de ".$ano."<br /> al ".$dia2." de ".$mes[intval($mes2)]." de ".$ano2;
    } 		
		?>
<div align="center" id="tablaimpr">
	<div class="tablaCentrada" id="tabla_reporte">
    <p align="center" class="titulos_reportes">ORDENES TOTALIZADAS EN EXTRUDER Y/O IMPRESI&oacute;N<br></p>
	<form name="form" action="<?=$_SERVER['PHP_SELF']?>?seccion=<?=$_REQUEST['seccion']?>" method="post">
...
<? if( $_REQUEST['formaR'] == 3 ||  $_REQUEST['formaR'] == 1 ){ ?> 
...
<? } if( $_REQUEST['formaR'] == 2 ||  $_REQUEST['formaR'] == 3){?>
        <table width="<?=$width1?>"  align="<?=$align1?>" class="titulos_i">
        <tr>
            <td colspan="5" align="center"><h3>Kilogramos en Impresi&Oacute;n</h3></td>
        </tr>
        <tr>
			<td width="14%" align="center"><strong>Fecha</strong></td>
			<td width="14%" align="center"><strong>Turno</strong></td>
                            ...
                            <? 
								for($z = 0; $dOrdenesI	=	mysql_fetch_assoc($rOrdenesI);$z++){ 
								$id_ma = $dOrdenesI['id_detalle_resumen_maquina_im']; 
                                if($dOrdenesI['orden_trabajo'] ==  ""){ $z = $z+1; } else { ?>
                            <tr <? 
								if($_REQUEST['ordenExt'] == ""  && $_REQUEST['modeloExt'] != 1 ) 
								$color = $dOrdenesI['dia'];
								else if($_REQUEST['ordenExt'] == ""  && $_REQUEST['modeloExt'] == 1 )
							...
							if(bcmod(intval($color),2) == 0){ 
								...
								echo "bgcolor='".$back."'";
                           	  ...
                           	  <? if($_REQUEST['modeloExt'] == 2 ){ ?>
                              <td align="center" class="style7"><b><?=preg_replace( "/^\s*([0-9]{1,4})[\/\. -]+([0-9]{1,2})[\/\. -]+([0-9]{1,2})/" , "\\3/\\2/\\1" ,$dOrdenesI['fecha'])?></b></td>
                               <? if( $_REQUEST['ordenExt'] != "" ){ ?>
                              <td align="center" class="style7"><b><?=$dOrdenesI['turno'];?></b></td>
                              <td align="center" class="style7"><b><?=$dOrdenesI['numero'];?></b></td>
                              <? }	 ?>
                           	  <td align="center" class="style7">
                              <? if($concentrado_ot_mod){?>
                            ...
                            <? 
							$TotalKilosI		+=	$dOrdenesI['kilogramos'];
                            ...
                            <tr>
                           	  <td colspan="<?=$g?>" align="right">TOTAL:</td>
                                <td align="right" class="style5"><b><?=floor($TotalKilosI);?></b></td>
                            </tr>
			</table>
 <? } ?>        
		</td>
...
/*echo	$qMqP	=	" SELECT * FROM resumen_maquina_ex "	.
				" INNER JOIN orden_produccion 	ON resumen_maquina_ex.id_orden_produccion 	= orden_produccion.id_orden_produccion ".
				" INNER JOIN entrada_general 	ON entrada_general.id_entrada_general 		= orden_produccion.id_entrada_general ".
				" INNER JOIN maquina 	ON resumen_maquina_ex.id_maquina 		= maquina.id_maquina ".
	...
	$qAM	=	"SELECT area, numero FROM maquina WHERE id_maquina	=	".$_REQUEST['maq_id']."";
	$rAM	=	mysql_query($qAM);
...
if($_REQUEST['area_maq'] == 2){
	...
	$qMqP	=	" SELECT * FROM resumen_maquina_im "	.
				" INNER JOIN impresion 	ON resumen_maquina_im.id_impresion 	= impresion.id_impresion ".
				" INNER JOIN entrada_general 	ON entrada_general.id_entrada_general 		= impresion.id_entrada_general ".
				" INNER JOIN maquina 	ON resumen_maquina_im.id_maquina 		= maquina.id_maquina ".
...
if($_REQUEST['area_maq'] == 3){
	...
	$qMq	=	" SELECT  SUM(resumen_maquina_bs.kilogramos) AS total, resumen_maquina_bs.id_maquina AS id_maquina, maquina.numero, fecha, maquina.area   FROM resumen_maquina_bs "	.
	...
	$qMqP	=	" SELECT * FROM resumen_maquina_bs "	.
				" INNER JOIN bolseo 	ON resumen_maquina_bs.id_bolseo 	= 	bolseo.id_bolseo ".
				" INNER JOIN maquina 	ON resumen_maquina_bs.id_maquina 	= 	maquina.id_maquina ".
                    ...
                    <td colspan="5">
                            <b class="xtop"><b class="xb1"></b><b class="xb2"></b><b class="xb3"></b><b class="xb4"></b></b>
                                <div class="xboxcontent" style="background-color: #ffffff">
                           	  <table width="100%" align="center">
                                            <tr valign="top">
                                       	  		<td width="52%" align="left"><table align="left" width="99%">
                                            <tr>
                                              <td height="28" colspan="2" align="center"><h3><?=$mes[$_REQUEST['mes_maq']]?> de <?=$_REQUEST['ano_maq']?></h3></td>
                                              <td colspan="2" height="28"><h3>Maq : <?
                                            ...
                                            <tr>
                                              ...
                                              <td width="105" align="center"><h3>Produccion</h3></td>
                                              <td width="68" align="center"><h3>Meta</h3></td>
                                              <td width="94" align="center"><h3>Diferencia</h3></td>
                                            </tr>
                                            <? $a = 0; $metas_maquinas= 0; while($dMq	=	mysql_fetch_assoc($rMq)){ 
													...
													$diferencia	=	$dMq['total']-$metas_maquinas;
													?>
                                            <tr <? cebra($a)?>>
                                                 <td align="center"><? fecha($dMq['fecha'])?></td>
                                                 <td align="right" class="style5"><? printf("%.2f" ,$dMq['total'])?></td>
                                                 <td align="right" class="style5"><? printf("%.2f" ,$metas_maquinas)?></td>
                                                 <td align="right" class="style5"><? printf("%.2f" ,$diferencia)?></td>
                                            </tr>
                                            <? 	$a++;
                                            ...
                                            <tr>
                                            	<td><h3>Totales: </h3></td>
                                                <td align="right"><? printf("%.2f" ,$total_prod)?></td>
                                                <td align="right"><? printf("%.2f" ,$Total_metas)?></td>
                                              	<td align="right"><? printf("%.2f" ,$total_dif)?></td>
                                            </tr>
                                            <tr>
                                    	...
                                    	<td width="1%">&nbsp;</td>
               	    	  <td width="47%" align="left" ><table align="left" width="100%"><tr height="25"><td align="center"><table align="left" width="100%">
                            <tr>
...
<tr>
    ...
    <br><br>
      ...
      <input type="button" value="Regresar" class="styleTabla button1" onClick="history.go(-1)" />
    </td>
</tr>

 <tr>	
    <td colspan="11" align="center"><br /><br />
        </td>
